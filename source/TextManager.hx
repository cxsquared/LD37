...
typedef TextData = { text:String, length:Float, showOnTop:Bool }
...
class TextManager extends FlxGroup
{
    ...
    public function showText(text:String, length:Float, showOnTop:Bool=false):Void
    {
        if (!showingText)
        {
        ...
        {
            var textData:TextData = {text:text,length:length,showOnTop:showOnTop};
