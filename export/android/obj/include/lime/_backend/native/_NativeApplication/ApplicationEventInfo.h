...
HX_DECLARE_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_657_new)
...
HXLINE( 659)		( ( ::lime::_backend::native::_NativeApplication::ApplicationEventInfo)(__this) )->type = type;
HXLINE( 660)		( ( ::lime::_backend::native::_NativeApplication::ApplicationEventInfo)(__this) )->deltaTime = deltaTime;
            	}
