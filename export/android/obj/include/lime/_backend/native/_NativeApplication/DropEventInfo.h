...
HX_DECLARE_STACK_FRAME(_hx_pos_cc1242aa9b04079d_690_new)
...
HXLINE( 692)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->type = type;
HXLINE( 693)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->file = file;
            	}
