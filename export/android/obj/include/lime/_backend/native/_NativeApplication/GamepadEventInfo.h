...
HX_DECLARE_STACK_FRAME(_hx_pos_3b7a66bddb205621_725_new)
...
HXLINE( 727)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->type = type;
HXLINE( 728)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->id = id;
HXLINE( 729)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->button = button;
HXLINE( 730)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->axis = axis;
HXLINE( 731)		( ( ::lime::_backend::native::_NativeApplication::GamepadEventInfo)(__this) )->value = value;
            	}
