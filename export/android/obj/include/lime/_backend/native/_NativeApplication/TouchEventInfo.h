...
HX_DECLARE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1011_new)
...
int device = __o_device.Default(0);
            	HX_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1011_new)
...
HXLINE(1013)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->type = type;
HXLINE(1014)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->x = x;
HXLINE(1015)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->y = y;
HXLINE(1016)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->id = id;
HXLINE(1017)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dx = dx;
HXLINE(1018)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->dy = dy;
HXLINE(1019)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->pressure = pressure;
HXLINE(1020)		( ( ::lime::_backend::native::_NativeApplication::TouchEventInfo)(__this) )->device = device;
            	}
