...
HX_DECLARE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_768_new)
...
int y = __o_y.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 770)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->type = type;
HXLINE( 771)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->id = id;
HXLINE( 772)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->index = index;
HXLINE( 773)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->value = value;
HXLINE( 774)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->x = x;
HXLINE( 775)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->y = y;
            	}
