...
HX_DECLARE_STACK_FRAME(_hx_pos_d4a11b6fb4b30fe3_969_new)
...
HXLINE( 971)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->type = type;
HXLINE( 972)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->windowID = windowID;
HXLINE( 973)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->text = text;
HXLINE( 974)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->start = start;
HXLINE( 975)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->length = length;
            	}
