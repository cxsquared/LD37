...
HX_DECLARE_STACK_FRAME(_hx_pos_c51b2e87fb75d55f_23_new)
...
HXLINE(  25)		( ( ::lime::ui::Touch)(__this) )->x = x;
HXLINE(  26)		( ( ::lime::ui::Touch)(__this) )->y = y;
HXLINE(  27)		( ( ::lime::ui::Touch)(__this) )->id = id;
HXLINE(  28)		( ( ::lime::ui::Touch)(__this) )->dx = dx;
HXLINE(  29)		( ( ::lime::ui::Touch)(__this) )->dy = dy;
HXLINE(  30)		( ( ::lime::ui::Touch)(__this) )->pressure = pressure;
HXLINE(  31)		( ( ::lime::ui::Touch)(__this) )->device = device;
            	}
