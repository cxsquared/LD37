...
HX_DECLARE_STACK_FRAME(_hx_pos_102f69689d37b2bb_213_new)
...
HXLINE( 215)		( ( ::haxe::Timer)(__this) )->mTime = time;
HXLINE( 216)		::haxe::Timer_obj::sRunningTimers->push(__this);
HXLINE( 217)		( ( ::haxe::Timer)(__this) )->mFireAt = (::haxe::Timer_obj::getMS() + ( ( ::haxe::Timer)(__this) )->mTime);
HXLINE( 218)		( ( ::haxe::Timer)(__this) )->mRunning = true;
            	}
