...
class HXCPP_CLASS_ATTRIBUTES FlxCamera_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		static  ::openfl::VectorData drawVertices;
		...
		Float initialZoom;
		 ...
		 ::flixel::graphics::tile::FlxDrawTilesItem startQuadBatch( ::flixel::graphics::FlxGraphic graphic,bool colored,hx::Null< bool >  hasColorOffsets,::String blend,hx::Null< bool >  smooth, ::openfl::display::Shader shader);
		::Dynamic startQuadBatch_dyn();

		 ::flixel::graphics::tile::FlxDrawTrianglesItem startTrianglesBatch( ::flixel::graphics::FlxGraphic graphic,hx::Null< bool >  smoothing,hx::Null< bool >  isColored,::String blend);
		::Dynamic startTrianglesBatch_dyn();

		 ::flixel::graphics::tile::FlxDrawTrianglesItem getNewDrawTrianglesItem( ::flixel::graphics::FlxGraphic graphic,hx::Null< bool >  smoothing,hx::Null< bool >  isColored,::String blend);
		...
		void drawPixels( ::flixel::graphics::frames::FlxFrame frame, ::openfl::display::BitmapData pixels, ::flixel::math::FlxMatrix matrix, ::openfl::geom::ColorTransform transform,::String blend, ::Dynamic smoothing, ::openfl::display::Shader shader);
		::Dynamic drawPixels_dyn();

		void copyPixels( ::flixel::graphics::frames::FlxFrame frame, ::openfl::display::BitmapData pixels, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint, ::openfl::geom::ColorTransform transform,::String blend, ::Dynamic smoothing, ::openfl::display::Shader shader);
		::Dynamic copyPixels_dyn();

		void drawTriangles( ::flixel::graphics::FlxGraphic graphic,::Array< Float > vertices,::Array< int > indices,::Array< Float > uvtData,::Array< int > colors, ::flixel::math::FlxPoint position,::String blend,hx::Null< bool >  repeat,hx::Null< bool >  smoothing);
