...
class HXCPP_CLASS_ATTRIBUTES GraphicLogo_obj : public  ::openfl::display::BitmapData_obj
{
	...
	public:
		...
		static hx::ObjectPtr< GraphicLogo_obj > __new(int width,int height, ::Dynamic transparent, ::Dynamic fillColor);
		static hx::ObjectPtr< GraphicLogo_obj > __alloc(hx::Ctx *_hx_ctx,int width,int height, ::Dynamic transparent, ::Dynamic fillColor);
