...
class HXCPP_CLASS_ATTRIBUTES FlxTypedSpriteGroup_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void transformChildren_openfl_display_BlendMode( ::Dynamic Function,::String Value);
		...
		void blendTransform( ::flixel::FlxSprite Sprite,::String Blend);
