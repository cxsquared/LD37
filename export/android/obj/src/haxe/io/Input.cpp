...
HX_DEFINE_STACK_FRAME(_hx_pos_220702dcc8429dc4_48_readByte,"haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","/usr/local/lib/haxe/std/haxe/io/Input.hx",48,0x3b290ab1)
HX_DEFINE_STACK_FRAME(_hx_pos_220702dcc8429dc4_89_close,"haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","/usr/local/lib/haxe/std/haxe/io/Input.hx",89,0x3b290ab1)
HX_DEFINE_STACK_FRAME(_hx_pos_220702dcc8429dc4_174_readLine,"haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","/usr/local/lib/haxe/std/haxe/io/Input.hx",174,0x3b290ab1)
namespace haxe{
namespace io{
...
int Input_obj::readByte(){
            	HX_STACKFRAME(&_hx_pos_220702dcc8429dc4_48_readByte)
            	HX_STACK_THIS(this)
...
void Input_obj::close(){
            	HX_STACKFRAME(&_hx_pos_220702dcc8429dc4_89_close)
            	HX_STACK_THIS(this)
            	}
...
::String Input_obj::readLine(){
            	HX_GC_STACKFRAME(&_hx_pos_220702dcc8429dc4_174_readLine)
            	HX_STACK_THIS(this)
