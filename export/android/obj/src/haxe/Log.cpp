...
HX_DEFINE_STACK_FRAME(_hx_pos_ec92f2a531d19fe2_75___default_trace,"haxe.Log","__default_trace",0xe2f5e5d5,"haxe.Log.__default_trace","/usr/local/lib/haxe/std/haxe/Log.hx",75,0x77937646)
namespace haxe{
...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_ec92f2a531d19fe2_75___default_trace)
            	HX_STACK_ARG(v,"v")
