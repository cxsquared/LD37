...
HX_DEFINE_STACK_FRAME(_hx_pos_0e14b7ff05c9131a_37_setMotion,"flixel.tweens.motion.CircularMotion","setMotion",0x3f8a8423,"flixel.tweens.motion.CircularMotion.setMotion","flixel/tweens/motion/CircularMotion.hx",37,0x4765ac04)
HX_DEFINE_STACK_FRAME(_hx_pos_0e14b7ff05c9131a_58_update,"flixel.tweens.motion.CircularMotion","update",0x6646b47e,"flixel.tweens.motion.CircularMotion.update","flixel/tweens/motion/CircularMotion.hx",58,0x4765ac04)
HX_DEFINE_STACK_FRAME(_hx_pos_0e14b7ff05c9131a_71_get_circumference,"flixel.tweens.motion.CircularMotion","get_circumference",0x1cf82811,"flixel.tweens.motion.CircularMotion.get_circumference","flixel/tweens/motion/CircularMotion.hx",71,0x4765ac04)
namespace flixel{
namespace tweens{
namespace motion{
...
HXLINE(  50)			this->duration = ((Float)(this->_radius * (::Math_obj::PI * (int)2)) / (Float)DurationOrSpeed);
            		}
