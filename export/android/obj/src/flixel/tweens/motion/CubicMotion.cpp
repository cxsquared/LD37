...
HX_DEFINE_STACK_FRAME(_hx_pos_fcae3222e31e2270_34_setMotion,"flixel.tweens.motion.CubicMotion","setMotion",0x132089c6,"flixel.tweens.motion.CubicMotion.setMotion","flixel/tweens/motion/CubicMotion.hx",34,0x44d248a3)
HX_DEFINE_STACK_FRAME(_hx_pos_fcae3222e31e2270_49_update,"flixel.tweens.motion.CubicMotion","update",0x63341afb,"flixel.tweens.motion.CubicMotion.update","flixel/tweens/motion/CubicMotion.hx",49,0x44d248a3)
namespace flixel{
namespace tweens{
namespace motion{
...
HXLINE(  51)		this->x = ((((((this->scale * this->scale) * this->scale) * ((this->_toX + ((int)3 * (this->_aX - this->_bX))) - this->_fromX)) + ((((int)3 * this->scale) * this->scale) * ((this->_fromX - ((int)2 * this->_aX)) + this->_bX))) + (((int)3 * this->scale) * (this->_aX - this->_fromX))) + this->_fromX);
HXLINE(  52)		this->y = ((((((this->scale * this->scale) * this->scale) * ((this->_toY + ((int)3 * (this->_aY - this->_bY))) - this->_fromY)) + ((((int)3 * this->scale) * this->scale) * ((this->_fromY - ((int)2 * this->_aY)) + this->_bY))) + (((int)3 * this->scale) * (this->_aY - this->_fromY))) + this->_fromY);
