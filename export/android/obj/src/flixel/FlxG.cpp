...
HX_DEFINE_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_312_resizeWindow,"flixel.FlxG","resizeWindow",0x41839acb,"flixel.FlxG.resizeWindow","flixel/FlxG.hx",312,0x8e176836)
...
void FlxG_obj::resizeWindow(int Width,int Height){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_312_resizeWindow)
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
            	}
...
HXLINE( 453)		if (::openfl::display::OpenGLView_obj::get_isSupported()) {
...
HXLINE( 519)		 ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + URL));
            	}
...
HXLINE( 538)		::flixel::FlxG_obj::scaleMode->onMeasure(::openfl::Lib_obj::current->stage->stageWidth,::openfl::Lib_obj::current->stage->stageHeight);
HXLINE( 550)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp = ::flixel::FlxG_obj::inputs;
HXDLIN( 550)		::flixel::FlxG_obj::touches = _hx_tmp->add_flixel_input_touch_FlxTouchManager( ::flixel::input::touch::FlxTouchManager_obj::__alloc( HX_CTX ));
HXLINE( 554)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::inputs;
HXDLIN( 554)		::flixel::FlxG_obj::gamepads = _hx_tmp1->add_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager_obj::__alloc( HX_CTX ));
HXLINE( 558)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::inputs;
HXDLIN( 558)		::flixel::FlxG_obj::android = _hx_tmp2->add_flixel_input_android_FlxAndroidKeys( ::flixel::input::android::FlxAndroidKeys_obj::__alloc( HX_CTX ));
HXLINE( 562)		::flixel::FlxG_obj::accelerometer =  ::flixel::input::FlxAccelerometer_obj::__alloc( HX_CTX );
...
HXLINE( 579)		if (!(( (bool)( ::Dynamic(::openfl::Lib_obj::application->config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic))->__GetItem((int)0)->__Field(HX_("hardware",a8,e2,d3,75),hx::paccDynamic)) ))) {
HXLINE( 581)			::flixel::FlxG_obj::renderMethod = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
            		}
            		else {
HXLINE( 585)			 ::flixel::FlxRenderMethod _hx_tmp;
HXDLIN( 585)			switch((int)(_hx_getEnumValueIndex(::openfl::Lib_obj::current->stage->window->renderer->type))){
            				case (int)1: case (int)3: case (int)4: {
HXLINE( 585)					_hx_tmp = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
            				}
            				break;
            				case (int)0: case (int)5: {
HXLINE( 585)					_hx_tmp = ::flixel::FlxRenderMethod_obj::DRAW_TILES_dyn();
            				}
            				break;
            				default:{
HXLINE( 585)					_hx_tmp = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
...
HXDLIN( 585)			::flixel::FlxG_obj::renderMethod = _hx_tmp;
            		}
...
HXLINE( 684)		if (hx::IsNotNull( ::flixel::FlxG_obj::game->stage )) {
HXLINE( 686)			::flixel::FlxG_obj::game->stage->__Field(HX_("set_frameRate",90,c7,8e,3f),hx::paccDynamic)(::flixel::FlxG_obj::drawFramerate);
            		}
...
HXLINE( 701)		if ((( (::String)(::openfl::Lib_obj::current->stage->__Field(HX_("get_displayState",f8,38,03,95),hx::paccDynamic)()) ) != HX_("fullScreen",5b,ae,48,2e))) {
HXLINE( 701)			return (( (::String)(::openfl::Lib_obj::current->stage->__Field(HX_("get_displayState",f8,38,03,95),hx::paccDynamic)()) ) == HX_("fullScreenInteractive",47,df,d1,02));
            		}
            		else {
...
HXLINE( 707)		::String _hx_tmp;
HXDLIN( 707)		if (Value) {
HXLINE( 707)			_hx_tmp = HX_("fullScreen",5b,ae,48,2e);
            		}
            		else {
HXLINE( 707)			_hx_tmp = HX_("normal",27,72,69,30);
            		}
HXDLIN( 707)		::openfl::Lib_obj::current->stage->__Field(HX_("set_displayState",6c,26,45,eb),hx::paccDynamic)(_hx_tmp);
...
HXLINE( 713)		return ::openfl::Lib_obj::current->stage;
            	}
...
HXLINE( 169)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
