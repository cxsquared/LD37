...
HXLINE(  20)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get().StaticCast<  ::flixel::math::FlxPoint >()->set((int)0,(int)0);
HXDLIN(  20)		point->_inPool = false;
HXDLIN(  20)		this->deviceSize = point;
HXLINE(  21)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get().StaticCast<  ::flixel::math::FlxPoint >()->set((int)0,(int)0);
HXDLIN(  21)		point1->_inPool = false;
HXDLIN(  21)		this->gameSize = point1;
HXLINE(  22)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = ::flixel::math::FlxPoint_obj::_pool->get().StaticCast<  ::flixel::math::FlxPoint >()->set((int)0,(int)0);
HXDLIN(  22)		point2->_inPool = false;
HXDLIN(  22)		this->scale = point2;
HXLINE(  23)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point3,"point") = ::flixel::math::FlxPoint_obj::_pool->get().StaticCast<  ::flixel::math::FlxPoint >()->set((int)0,(int)0);
...
HXLINE(  86)		::flixel::FlxG_obj::game->__Field(HX_("set_x",5b,9b,2f,7a),hx::paccDynamic)(this->offset->x);
HXLINE(  87)		::flixel::FlxG_obj::game->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic)(this->offset->y);
            	}
