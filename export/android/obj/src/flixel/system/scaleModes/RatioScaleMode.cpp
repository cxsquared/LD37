...
HX_DEFINE_STACK_FRAME(_hx_pos_35d034ea7d537e63_20_updateGameSize,"flixel.system.scaleModes.RatioScaleMode","updateGameSize",0xacc31ced,"flixel.system.scaleModes.RatioScaleMode.updateGameSize","flixel/system/scaleModes/RatioScaleMode.hx",20,0x35e4ce80)
namespace flixel{
...
HXLINE(  33)			this->gameSize->set_y(::Math_obj::floor(((Float)this->gameSize->x / (Float)ratio)));
            		}
            		else {
HXLINE(  37)			this->gameSize->set_y(Height);
HXLINE(  38)			this->gameSize->set_x(::Math_obj::floor((this->gameSize->y * ratio)));
            		}
            	}
