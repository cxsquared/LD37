...
HXDLIN( 242)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 242)		_this->label = HX_("variables",b7,e2,62,82);
HXDLIN( 242)		_this->value = value;
HXLINE( 243)		 ::Dynamic value1 = this->extensions;
HXDLIN( 243)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
