...
HXLINE(  36)		this->label->__Field(HX_("set_x",5b,9b,2f,7a),hx::paccDynamic)((int)4);
...
bool CompletionListEntry_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x3ac19654;
}
...
HXLINE(  50)		this->label->__Field(HX_("set_text",aa,e1,11,7b),hx::paccDynamic)(item);
HXLINE(  51)		if ((( (Float)(this->label->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) ) > (int)150)) {
HXLINE(  53)			this->label->__Field(HX_("set_width",69,fe,5c,f1),hx::paccDynamic)((int)150);
HXLINE(  54)			this->label->__Field(HX_("set_autoSize",4d,67,8c,f9),hx::paccDynamic)(HX_("none",b8,12,0a,49));
            		}
            	}
