...
HXLINE(  19)		hx::ObjectPtr<OBJ_>(this)->__Field(HX_("set_x",5b,9b,2f,7a),hx::paccDynamic)(x);
HXLINE(  20)		hx::ObjectPtr<OBJ_>(this)->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic)(y);
...
HXLINE(  29)		 ::Dynamic _hx_tmp = this->handle->__Field(HX_("set_scaleY",cc,f8,2a,30),hx::paccDynamic);
HXDLIN(  29)		Float _hx_tmp1 = (((Float)( (Float)(hx::ObjectPtr<OBJ_>(this)->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) ) / (Float)items) * entries);
HXDLIN(  29)		_hx_tmp(::Math_obj::min(_hx_tmp1,( (Float)(hx::ObjectPtr<OBJ_>(this)->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) )));
HXLINE(  30)		 ::Dynamic _hx_tmp2 = this->handle->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic);
HXDLIN(  30)		_hx_tmp2((((Float)( (Float)(hx::ObjectPtr<OBJ_>(this)->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) ) / (Float)items) * lower));
HXLINE(  31)		 ::Dynamic _hx_tmp3 = this->handle->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic);
HXDLIN(  31)		HX_VARI( Float,Value) = ( (Float)(this->handle->__Field(HX_("get_y",50,a5,60,91),hx::paccDynamic)()) );
HXDLIN(  31)		HX_VARI( Float,Max) = ( (Float)(hx::ObjectPtr<OBJ_>(this)->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) );
HXDLIN(  31)		HX_VARI_NAME(  ::Dynamic,Max1,"Max") = (Max - ( (Float)(this->handle->__Field(HX_("get_scaleY",58,5a,ad,2c),hx::paccDynamic)()) ));
