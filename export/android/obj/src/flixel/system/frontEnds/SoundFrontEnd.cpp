...
HXDLIN( 152)		if (!(::openfl::Assets_obj::exists(EmbeddedSound,HX_("SOUND",af,c4,ba,fe)))) {
...
HXDLIN( 168)			if (!(::openfl::Assets_obj::exists(id,HX_("SOUND",af,c4,ba,fe)))) {
...
HXLINE( 187)			 ::openfl::media::Sound EmbeddedSound1;
HXDLIN( 187)			bool EmbeddedSound2;
HXDLIN( 187)			if (!(::openfl::Assets_obj::exists(( (::String)(EmbeddedSound) ),HX_("SOUND",af,c4,ba,fe)))) {
HXLINE( 187)				EmbeddedSound2 = ::openfl::Assets_obj::exists(( (::String)(EmbeddedSound) ),HX_("MUSIC",85,08,49,8e));
            			}
            			else {
HXLINE( 187)				EmbeddedSound2 = true;
            			}
HXDLIN( 187)			if (EmbeddedSound2) {
HXLINE( 187)				EmbeddedSound1 = ::openfl::Assets_obj::getSound(( (::String)(EmbeddedSound) ),true);
            			}
            			else {
