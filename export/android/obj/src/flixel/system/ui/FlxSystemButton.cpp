...
bool FlxSystemButton_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2ecd4574;
}
...
HXDLIN( 116)			HX_VARI_NAME(  ::Dynamic,_g1,"_g") = _g->__Field(HX_("set_alpha",c1,ef,90,48),hx::paccDynamic);
HXDLIN( 116)			_g1((( (Float)(_g->__Field(HX_("get_alpha",b5,03,40,65),hx::paccDynamic)()) ) - ((Float)0.2)));
            		}
            	}
...
HXDLIN( 122)			HX_VARI_NAME(  ::Dynamic,_g1,"_g") = _g->__Field(HX_("set_alpha",c1,ef,90,48),hx::paccDynamic);
HXDLIN( 122)			_g1((( (Float)(_g->__Field(HX_("get_alpha",b5,03,40,65),hx::paccDynamic)()) ) + ((Float)0.2)));
            		}
            	}
...
HXDLIN( 128)			hx::ObjectPtr<OBJ_>(this)->__Field(HX_("set_alpha",c1,ef,90,48),hx::paccDynamic)(_hx_tmp);
            		}
