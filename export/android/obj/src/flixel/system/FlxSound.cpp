...
HXLINE( 251)		this->_time = ( (Float)(this->_channel->__Field(HX_("get_position",b2,54,14,80),hx::paccDynamic)()) );
...
HXDLIN( 259)			HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get().StaticCast<  ::flixel::math::FlxPoint >()->set(X,Y);
...
HXLINE( 286)			_hx_tmp1 = hx::IsGreaterEq( this->_time,this->endTime );
            		}
            		else {
...
HXLINE( 312)		if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::openfl::media::Sound >())) {
HXLINE( 314)			this->_sound = ( ( ::openfl::media::Sound)(EmbeddedSound) );
            		}
            		else {
...
HXDLIN( 322)					if (!(::openfl::Assets_obj::exists(( (::String)(EmbeddedSound) ),HX_("SOUND",af,c4,ba,fe)))) {
HXLINE( 322)						_hx_tmp = ::openfl::Assets_obj::exists(( (::String)(EmbeddedSound) ),HX_("MUSIC",85,08,49,8e));
            					}
            					else {
HXLINE( 322)						_hx_tmp = true;
            					}
HXDLIN( 322)					if (_hx_tmp) {
HXLINE( 324)						this->_sound = ::openfl::Assets_obj::getSound(( (::String)(EmbeddedSound) ),null());
            					}
            				}
            			}
            		}
...
HXLINE( 346)		this->_sound =  ::openfl::media::Sound_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 347)		this->_sound->addEventListener(HX_("id3",f8,03,50,00),this->gotID3_dyn(),null(),null(),null());
HXLINE( 348)		 ::openfl::media::Sound _hx_tmp = this->_sound;
HXDLIN( 348)		_hx_tmp->load( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,SoundURL),null());
...
HXLINE( 382)			_hx_tmp = ( (Float)(this->_sound->__Field(HX_("get_length",af,04,8f,8f),hx::paccDynamic)()) );
            		}
...
HXLINE( 456)		this->_time = ( (Float)(this->_channel->__Field(HX_("get_position",b2,54,14,80),hx::paccDynamic)()) );
...
HXLINE( 546)			this->_channel->__Field(HX_("set_soundTransform",da,01,28,9b),hx::paccDynamic)(this->_transform);
            		}
            	}
...
void FlxSound_obj::gotID3( ::Dynamic _){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE( 632)		this->name = ( ( ::openfl::media::ID3Info)(this->_sound->__Field(HX_("get_id3",8f,cc,c4,26),hx::paccDynamic)()) )->songName;
HXLINE( 633)		this->artist = ( ( ::openfl::media::ID3Info)(this->_sound->__Field(HX_("get_id3",8f,cc,c4,26),hx::paccDynamic)()) )->artist;
...
HXDLIN( 737)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 737)		_this->label = HX_("playing",6e,0f,18,8a);
HXDLIN( 737)		_this->value = value;
HXLINE( 738)		 ::Dynamic value1 = this->_time;
HXDLIN( 738)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 738)		_this1->label = HX_("time",0d,cc,fc,4c);
HXDLIN( 738)		_this1->value = value1;
HXLINE( 739)		 ::Dynamic value2 = this->_length;
HXDLIN( 739)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 739)		_this2->label = HX_("length",e6,94,07,9f);
HXDLIN( 739)		_this2->value = value2;
HXLINE( 740)		 ::Dynamic value3 = this->_volume;
HXDLIN( 740)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
