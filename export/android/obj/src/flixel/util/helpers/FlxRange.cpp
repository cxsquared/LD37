...
HXDLIN(  67)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(  67)		_this->label = HX_("start",62,74,0b,84);
HXDLIN(  67)		_this->value = value;
HXLINE(  68)		 ::Dynamic value1 = this->end;
HXDLIN(  68)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
