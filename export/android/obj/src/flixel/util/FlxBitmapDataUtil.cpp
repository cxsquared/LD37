...
HXLINE( 184)				HX_VARI(  ::openfl::display::BitmapData,result) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,(int)0);
...
HXLINE( 299)						HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get().StaticCast<  ::flixel::math::FlxPoint >()->set(x,y);
...
HXDLIN( 329)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXLINE( 362)		HX_VARI_NAME(  ::openfl::display::BitmapData,result1,"result") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,result,::Std_obj::_hx_int(((region->height + ((numVerticalFrames - (int)1) * spaceY)) + (((int)2 * numVerticalFrames) * borderY))),true,(int)0);
HXLINE( 368)		result1->lock();
HXLINE( 369)		HX_VARI(  ::openfl::geom::Rectangle,tempRect) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,frameWidth,frameHeight);
HXLINE( 370)		HX_VARI(  ::openfl::geom::Point,tempPoint) =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 373)		{
...
HXLINE( 411)		HX_VARI(  ::openfl::geom::Rectangle,tempRect) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,(int)1,bitmapData->height);
HXLINE( 412)		HX_VARI(  ::openfl::geom::Point,tempPoint) =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 482)		HX_VARI(  ::openfl::display::BitmapData,result) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(max * columns),(max * rows),true,(int)0);
