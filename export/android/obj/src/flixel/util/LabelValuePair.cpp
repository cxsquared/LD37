...
HX_DEFINE_DYNAMIC_FUNC0(LabelValuePair_obj,destroy,(void))
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::weak(::String label, ::Dynamic value){
            	...
            	HX_STACK_ARG(label,"label")
            	HX_STACK_ARG(value,"value")
HXLINE( 608)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
...
HXLINE( 604)		_pool =  ::flixel::util::FlxPool_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::util::LabelValuePair >());
            	}
}
