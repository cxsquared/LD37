...
HXLINE( 189)		this->textField =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
HXLINE( 190)		this->textField->__Field(HX_("set_selectable",53,27,40,5a),hx::paccDynamic)(false);
HXLINE( 191)		this->textField->__Field(HX_("set_multiline",d0,88,7b,a4),hx::paccDynamic)(true);
HXLINE( 192)		this->textField->__Field(HX_("set_wordWrap",31,ec,ed,ca),hx::paccDynamic)(true);
HXLINE( 193)		this->_defaultFormat =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,null(),Size,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 194)		this->set_font(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT);
HXLINE( 195)		this->_formatAdjusted =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 196)		this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
HXLINE( 197)		this->textField->__Field(HX_("set_text",aa,e1,11,7b),hx::paccDynamic)(Text);
HXLINE( 198)		this->set_fieldWidth(FieldWidth);
HXLINE( 199)		this->textField->__Field(HX_("set_embedFonts",e8,37,f7,24),hx::paccDynamic)(EmbeddedFont);
...
HXDLIN( 205)		this->textField->__Field(HX_("set_height",24,16,51,f6),hx::paccDynamic)(_hx_tmp1);
HXLINE( 207)		this->set_allowCollisions((int)0);
HXLINE( 208)		this->set_moves(false);
HXLINE( 210)		this->drawFrame(null());
HXLINE( 212)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get().StaticCast<  ::flixel::math::FlxPoint >()->set((int)1,(int)1);
...
HXLINE( 431)		{
HXLINE( 431)			this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
...
HXLINE( 468)		{
HXLINE( 468)			this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
...
HXLINE( 505)			this->textField->__Field(HX_("set_width",69,fe,5c,f1),hx::paccDynamic)(value);
            		}
...
HXLINE( 514)			return this->textField->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)();
            		}
            		else {
...
HXLINE( 521)			::String _hx_tmp;
HXDLIN( 521)			if (value) {
HXLINE( 521)				_hx_tmp = HX_("left",07,08,b0,47);
            			}
            			else {
HXLINE( 521)				_hx_tmp = HX_("none",b8,12,0a,49);
            			}
HXDLIN( 521)			this->textField->__Field(HX_("set_autoSize",4d,67,8c,f9),hx::paccDynamic)(_hx_tmp);
...
HXLINE( 530)			return (( (::String)(this->textField->__Field(HX_("get_autoSize",d9,43,93,e4),hx::paccDynamic)()) ) != HX_("none",b8,12,0a,49));
            		}
            		else {
...
HXLINE( 538)			HX_VARI( ::String,ot) = ( (::String)(this->textField->__Field(HX_("get_text",36,88,b4,cc),hx::paccDynamic)()) );
HXLINE( 539)			this->textField->__Field(HX_("set_text",aa,e1,11,7b),hx::paccDynamic)(Text);
HXLINE( 540)			bool _hx_tmp;
HXDLIN( 540)			if ((( (::String)(this->textField->__Field(HX_("get_text",36,88,b4,cc),hx::paccDynamic)()) ) == ot)) {
...
HXLINE( 553)		{
HXLINE( 553)			this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
...
HXLINE( 565)		{
HXLINE( 565)			this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
...
::String FlxText_obj::set_font(::String Font){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Font,"Font")
HXLINE( 576)		this->textField->__Field(HX_("set_embedFonts",e8,37,f7,24),hx::paccDynamic)(true);
HXLINE( 578)		if (hx::IsNotNull( Font )) {
HXLINE( 580)			HX_VARI( ::String,newFontName) = Font;
HXLINE( 581)			if (::openfl::Assets_obj::exists(Font,HX_("FONT",cf,25,81,2e))) {
HXLINE( 583)				newFontName = ( (::String)(::openfl::Assets_obj::getFont(Font,null())->__Field(HX_("get_fontName",c3,43,97,80),hx::paccDynamic)()) );
            			}
...
HXLINE( 593)		{
HXLINE( 593)			this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
...
bool FlxText_obj::get_embedded(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 599)		return this->textField->__Field(HX_("set_embedFonts",e8,37,f7,24),hx::paccDynamic)(true);
            	}
...
::String FlxText_obj::set_systemFont(::String Font){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Font,"Font")
HXLINE( 609)		this->textField->__Field(HX_("set_embedFonts",e8,37,f7,24),hx::paccDynamic)(false);
HXLINE( 610)		this->_defaultFormat->font = Font;
HXLINE( 611)		{
HXLINE( 611)			this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
...
HXLINE( 625)			{
HXLINE( 625)				this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
...
HXLINE( 640)			{
HXLINE( 640)				this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
...
bool FlxText_obj::get_wordWrap(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 647)		return this->textField->__Field(HX_("get_wordWrap",bd,c8,f4,b5),hx::paccDynamic)();
            	}
...
bool FlxText_obj::set_wordWrap(bool value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 652)		if ((( (bool)(this->textField->__Field(HX_("get_wordWrap",bd,c8,f4,b5),hx::paccDynamic)()) ) != value)) {
HXLINE( 654)			this->textField->__Field(HX_("set_wordWrap",31,ec,ed,ca),hx::paccDynamic)(value);
...
HXLINE( 668)		{
HXLINE( 668)			this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
...
HXLINE( 758)		HX_VARI( Float,newWidth) = ( (Float)(this->textField->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) );
HXLINE( 760)		HX_VARI( Float,newHeight) = (( (Float)(this->textField->__Field(HX_("get_textHeight",bd,10,32,af),hx::paccDynamic)()) ) + (int)4);
HXLINE( 763)		if ((( (Float)(this->textField->__Field(HX_("get_textHeight",bd,10,32,af),hx::paccDynamic)()) ) == (int)0)) {
...
HXLINE( 778)			 ::Dynamic _hx_tmp3 = this->textField->__Field(HX_("set_height",24,16,51,f6),hx::paccDynamic);
HXDLIN( 778)			_hx_tmp3((this->get_height() * ((Float)1.2)));
...
HXLINE( 790)					this->_borderPixels =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->frameWidth,this->frameHeight,true,null());
            				}
            				else {
...
HXLINE( 796)			_hx_tmp5 = hx::IsNotNull( ( (::String)(this->textField->__Field(HX_("get_text",36,88,b4,cc),hx::paccDynamic)()) ) );
            		}
            		else {
HXLINE( 796)			_hx_tmp5 = false;
            		}
HXDLIN( 796)		if (_hx_tmp5) {
HXLINE( 796)			_hx_tmp4 = (( (::String)(this->textField->__Field(HX_("get_text",36,88,b4,cc),hx::paccDynamic)()) ).length > (int)0);
            		}
            		else {
...
HXLINE( 804)					this->_borderColorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            				}
...
HXLINE( 962)			this->_borderColorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            		}
...
HXLINE( 989)				int _hx_tmp1 = (( (::String)(this->textField->__Field(HX_("get_text",36,88,b4,cc),hx::paccDynamic)()) ).length - (int)1);
...
HXLINE(1001)				 ::openfl::text::TextField _hx_tmp3 = this->textField;
...
HXLINE(1001)				_hx_tmp3->setTextFormat(FormatAdjusted,formatRange1,::Std_obj::_hx_int(::Math_obj::min(formatRange2,( (::String)(this->textField->__Field(HX_("get_text",36,88,b4,cc),hx::paccDynamic)()) ).length)));
            			}
            			_hx_goto_58:;
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(FlxText_obj,copyTextFormat,(void))
 ...
 ::openfl::text::TextFormat FlxText_obj::dtfCopy(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1024)		HX_VARI(  ::openfl::text::TextFormat,dtf) = ( ( ::openfl::text::TextFormat)(this->textField->__Field(HX_("get_defaultTextFormat",bc,ca,8e,89),hx::paccDynamic)()) );
HXLINE(1025)		return  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,dtf->font,dtf->size,dtf->color,dtf->bold,dtf->italic,dtf->underline,dtf->url,dtf->target,dtf->align,null(),null(),null(),null());
            	}
...
void FlxText_obj::updateDefaultFormat(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1030)		this->textField->__Field(HX_("set_defaultTextFormat",c8,98,97,dd),hx::paccDynamic)(this->_defaultFormat);
