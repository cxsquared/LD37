...
HXDLIN(  56)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(  56)		_this->label = HX_("x",78,00,00,00);
HXDLIN(  56)		_this->value = value;
HXLINE(  57)		 ::Dynamic value1 = this->y;
HXDLIN(  57)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(  57)		_this1->label = HX_("y",79,00,00,00);
HXDLIN(  57)		_this1->value = value1;
HXLINE(  58)		 ::Dynamic value2 = this->rawUp;
HXDLIN(  58)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(  58)		_this2->label = HX_("rawUp",63,6a,26,e4);
HXDLIN(  58)		_this2->value = value2;
HXLINE(  59)		 ::Dynamic value3 = this->rawDown;
HXDLIN(  59)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(  59)		_this3->label = HX_("rawDown",6a,0e,23,ff);
HXDLIN(  59)		_this3->value = value3;
HXLINE(  60)		 ::Dynamic value4 = this->rawLeft;
HXDLIN(  60)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this4,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(  60)		_this4->label = HX_("rawLeft",0f,1e,65,04);
HXDLIN(  60)		_this4->value = value4;
HXLINE(  61)		 ::Dynamic value5 = this->rawRight;
HXDLIN(  61)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this5,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
...
HXDLIN(  62)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this6,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(  62)		_this6->label = HX_("digitalThreshold",b3,20,9a,6e);
HXDLIN(  62)		_this6->value = value6;
HXLINE(  63)		 ::Dynamic value7 = this->mode;
HXDLIN(  63)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this7,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
