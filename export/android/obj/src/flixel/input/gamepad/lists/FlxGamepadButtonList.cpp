...
HX_DEFINE_STACK_FRAME(_hx_pos_b0737e09367eab91_28_get_LEFT_TRIGGER,"flixel.input.gamepad.lists.FlxGamepadButtonList","get_LEFT_TRIGGER",0xc549e39c,"flixel.input.gamepad.lists.FlxGamepadButtonList.get_LEFT_TRIGGER","flixel/input/gamepad/lists/FlxGamepadButtonList.hx",28,0x834770bf)
HX_DEFINE_STACK_FRAME(_hx_pos_b0737e09367eab91_29_get_RIGHT_TRIGGER,"flixel.input.gamepad.lists.FlxGamepadButtonList","get_RIGHT_TRIGGER",0x7a39ecd9,"flixel.input.gamepad.lists.FlxGamepadButtonList.get_RIGHT_TRIGGER","flixel/input/gamepad/lists/FlxGamepadButtonList.hx",29,0x834770bf)
...
bool FlxGamepadButtonList_obj::get_LEFT_TRIGGER(){
            	HX_STACKFRAME(&_hx_pos_b0737e09367eab91_28_get_LEFT_TRIGGER)
            	HX_STACK_THIS(this)
HXLINE(  28)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,_this) = this->gamepad;
HXDLIN(  28)		int Status = this->status;
HXDLIN(  28)		return _this->checkStatusRaw(_this->mapping->getRawID((int)17),Status);
            	}
...
bool FlxGamepadButtonList_obj::get_RIGHT_TRIGGER(){
            	HX_STACKFRAME(&_hx_pos_b0737e09367eab91_29_get_RIGHT_TRIGGER)
            	HX_STACK_THIS(this)
HXLINE(  29)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,_this) = this->gamepad;
HXDLIN(  29)		int Status = this->status;
HXDLIN(  29)		return _this->checkStatusRaw(_this->mapping->getRawID((int)18),Status);
            	}
