...
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_39_getByID,"flixel.input.touch.FlxTouchManager","getByID",0x18c2ee75,"flixel.input.touch.FlxTouchManager.getByID","flixel/input/touch/FlxTouchManager.hx",39,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_47_getFirst,"flixel.input.touch.FlxTouchManager","getFirst",0xd4f3e5cd,"flixel.input.touch.FlxTouchManager.getFirst","flixel/input/touch/FlxTouchManager.hx",47,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_62_destroy,"flixel.input.touch.FlxTouchManager","destroy",0x29a37247,"flixel.input.touch.FlxTouchManager.destroy","flixel/input/touch/FlxTouchManager.hx",62,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_85_justStarted,"flixel.input.touch.FlxTouchManager","justStarted",0x4159d442,"flixel.input.touch.FlxTouchManager.justStarted","flixel/input/touch/FlxTouchManager.hx",85,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_116_justReleased,"flixel.input.touch.FlxTouchManager","justReleased",0x217e7e9c,"flixel.input.touch.FlxTouchManager.justReleased","flixel/input/touch/FlxTouchManager.hx",116,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_143_reset,"flixel.input.touch.FlxTouchManager","reset",0x90b1b1dc,"flixel.input.touch.FlxTouchManager.reset","flixel/input/touch/FlxTouchManager.hx",143,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_176_handleTouchBegin,"flixel.input.touch.FlxTouchManager","handleTouchBegin",0x51a5a0c5,"flixel.input.touch.FlxTouchManager.handleTouchBegin","flixel/input/touch/FlxTouchManager.hx",176,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_193_handleTouchEnd,"flixel.input.touch.FlxTouchManager","handleTouchEnd",0xa3529b77,"flixel.input.touch.FlxTouchManager.handleTouchEnd","flixel/input/touch/FlxTouchManager.hx",193,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_206_handleTouchMove,"flixel.input.touch.FlxTouchManager","handleTouchMove",0x4a3ff3f5,"flixel.input.touch.FlxTouchManager.handleTouchMove","flixel/input/touch/FlxTouchManager.hx",206,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_222_add,"flixel.input.touch.FlxTouchManager","add",0x0e8d4cee,"flixel.input.touch.FlxTouchManager.add","flixel/input/touch/FlxTouchManager.hx",222,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_237_recycle,"flixel.input.touch.FlxTouchManager","recycle",0x3ca95560,"flixel.input.touch.FlxTouchManager.recycle","flixel/input/touch/FlxTouchManager.hx",237,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_253_update,"flixel.input.touch.FlxTouchManager","update",0x8957295c,"flixel.input.touch.FlxTouchManager.update","flixel/input/touch/FlxTouchManager.hx",253,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_278_onFocus,"flixel.input.touch.FlxTouchManager","onFocus",0x9fe44386,"flixel.input.touch.FlxTouchManager.onFocus","flixel/input/touch/FlxTouchManager.hx",278,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_282_onFocusLost,"flixel.input.touch.FlxTouchManager","onFocusLost",0x9504548a,"flixel.input.touch.FlxTouchManager.onFocusLost","flixel/input/touch/FlxTouchManager.hx",282,0xc27259e6)
HX_DEFINE_STACK_FRAME(_hx_pos_267129cd6cd94d38_18_boot,"flixel.input.touch.FlxTouchManager","boot",0xadc79cc5,"flixel.input.touch.FlxTouchManager.boot","flixel/input/touch/FlxTouchManager.hx",18,0xc27259e6)
namespace flixel{
namespace input{
namespace touch{
...
HXLINE( 165)		::openfl::ui::Multitouch_obj::set_inputMode(HX_("touchPoint",11,98,20,c0));
HXLINE( 167)		::openfl::Lib_obj::current->stage->addEventListener(HX_("touchBegin",ea,cd,e6,a9),this->handleTouchBegin_dyn(),null(),null(),null());
HXLINE( 168)		::openfl::Lib_obj::current->stage->addEventListener(HX_("touchEnd",5c,c5,09,00),this->handleTouchEnd_dyn(),null(),null(),null());
HXLINE( 169)		::openfl::Lib_obj::current->stage->addEventListener(HX_("touchMove",70,72,cd,0d),this->handleTouchMove_dyn(),null(),null(),null());
            	}
...
HXDLIN(  63)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->list;
...
HXLINE(  69)		{
HXLINE(  69)			HX_VARI_NAME( int,_g2,"_g") = (int)0;
HXDLIN(  69)			HX_VARI_NAME( ::Array< ::Dynamic>,_g11,"_g1") = this->_inactiveTouches;
HXDLIN(  69)			while((_g2 < _g11->length)){
HXLINE(  69)				HX_VARI_NAME(  ::flixel::input::touch::FlxTouch,touch1,"touch") = _g11->__get(_g2).StaticCast<  ::flixel::input::touch::FlxTouch >();
...
HXDLIN(  98)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->list;
...
HXDLIN( 128)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->list;
...
HXDLIN( 149)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->list;
...
HXLINE( 177)		HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = this->_touchesCache->get(FlashEvent->touchPointID).StaticCast<  ::flixel::input::touch::FlxTouch >();
...
HXLINE( 184)			HX_VARI_NAME( int,touch1,"touch") = ::Std_obj::_hx_int(FlashEvent->stageX);
...
void FlxTouchManager_obj::handleTouchEnd( ::openfl::events::TouchEvent FlashEvent){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(FlashEvent,"FlashEvent")
HXLINE( 194)		HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = this->_touchesCache->get(FlashEvent->touchPointID).StaticCast<  ::flixel::input::touch::FlxTouch >();
...
void FlxTouchManager_obj::handleTouchMove( ::openfl::events::TouchEvent FlashEvent){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(FlashEvent,"FlashEvent")
HXLINE( 207)		HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = this->_touchesCache->get(FlashEvent->touchPointID).StaticCast<  ::flixel::input::touch::FlxTouch >();
...
HXLINE( 240)			HX_VARI(  ::flixel::input::touch::FlxTouch,touch) = this->_inactiveTouches->pop().StaticCast<  ::flixel::input::touch::FlxTouch >();
...
void FlxTouchManager_obj::update(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 254)		HX_VARI( int,i) = (this->list->length - (int)1);
HXLINE( 255)		HX_VAR(  ::flixel::input::touch::FlxTouch,touch);
HXLINE( 257)		while((i >= (int)0)){
HXLINE( 259)			touch = this->list->__get(i).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXLINE( 262)			bool _hx_tmp;
HXDLIN( 262)			HX_VARI(  ::flixel::input::FlxInput,_this) = touch->input;
