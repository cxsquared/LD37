...
HX_DEFINE_STACK_FRAME(_hx_pos_4f97e6ad904044d6_11_new,"flixel.input.android.FlxAndroidKeyList","new",0x85ddcc1d,"flixel.input.android.FlxAndroidKeyList.new","flixel/input/android/FlxAndroidKeyList.hx",11,0x85400236)
HX_DEFINE_STACK_FRAME(_hx_pos_4f97e6ad904044d6_13_get_BACK,"flixel.input.android.FlxAndroidKeyList","get_BACK",0x9a67b4d3,"flixel.input.android.FlxAndroidKeyList.get_BACK","flixel/input/android/FlxAndroidKeyList.hx",13,0x85400236)
HX_DEFINE_STACK_FRAME(_hx_pos_4f97e6ad904044d6_14_get_MENU,"flixel.input.android.FlxAndroidKeyList","get_MENU",0xa1b0204b,"flixel.input.android.FlxAndroidKeyList.get_MENU","flixel/input/android/FlxAndroidKeyList.hx",14,0x85400236)
namespace flixel{
namespace input{
namespace android{

void FlxAndroidKeyList_obj::__construct(int status, ::flixel::input::FlxKeyManager keyManager){
            	HX_STACKFRAME(&_hx_pos_4f97e6ad904044d6_11_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(status,"status")
            	HX_STACK_ARG(keyManager,"keyManager")
HXLINE(  11)		super::__construct(status,keyManager);
            	}
...
bool FlxAndroidKeyList_obj::get_BACK(){
            	HX_STACKFRAME(&_hx_pos_4f97e6ad904044d6_13_get_BACK)
            	HX_STACK_THIS(this)
HXLINE(  13)		return this->keyManager->checkStatus((int)27,this->status);
            	}
...
bool FlxAndroidKeyList_obj::get_MENU(){
            	HX_STACKFRAME(&_hx_pos_4f97e6ad904044d6_14_get_MENU)
            	HX_STACK_THIS(this)
HXLINE(  14)		return this->keyManager->checkStatus((int)16777234,this->status);
            	}
