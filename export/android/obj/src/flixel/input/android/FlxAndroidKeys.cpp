...
void FlxAndroidKeys_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  11)		super::__construct(hx::ClassOf< ::flixel::input::android::FlxAndroidKeyList >());
HXLINE(  14)		HX_VARI(  ::flixel::input::FlxInput,back) =  ::flixel::input::FlxInput_obj::__alloc( HX_CTX ,(int)27);
HXLINE(  15)		this->_keyListArray->push(back);
HXLINE(  16)		this->_keyListMap->set(( (int)(back->ID) ),back);
HXLINE(  19)		HX_VARI(  ::flixel::input::FlxInput,menu) =  ::flixel::input::FlxInput_obj::__alloc( HX_CTX ,(int)16777234);
