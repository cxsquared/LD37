...
HXLINE(  54)		HX_VARI(  ::flixel::effects::FlxFlicker,flicker) = ::flixel::effects::FlxFlicker_obj::_pool->get().StaticCast<  ::flixel::effects::FlxFlicker >();
...
HXLINE(  15)		_pool =  ::flixel::util::FlxPool_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::effects::FlxFlicker >());
            	}
{
