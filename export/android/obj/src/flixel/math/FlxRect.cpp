...
HXLINE( 373)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXDLIN( 401)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 401)		_this->label = HX_("x",78,00,00,00);
HXDLIN( 401)		_this->value = value;
HXLINE( 402)		 ::Dynamic value1 = this->y;
HXDLIN( 402)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 402)		_this1->label = HX_("y",79,00,00,00);
HXDLIN( 402)		_this1->value = value1;
HXLINE( 403)		 ::Dynamic value2 = this->width;
HXDLIN( 403)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 403)		_this2->label = HX_("w",77,00,00,00);
HXDLIN( 403)		_this2->value = value2;
HXLINE( 404)		 ::Dynamic value3 = this->height;
HXDLIN( 404)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
...
Float Height = __o_Height.Default(0);
            	...
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
HXLINE(  23)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(  23)		_this->x = X;
HXDLIN(  23)		_this->y = Y;
...
Float Height = __o_Height.Default(0);
            	...
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
HXLINE(  34)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(  34)		_this->x = X;
HXDLIN(  34)		_this->y = Y;
...
HXLINE(  15)		_pool =  ::flixel::util::FlxPool_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::math::FlxRect >());
            	}
}
