...
HX_DEFINE_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_184_angleBetweenTouch,"flixel.math.FlxAngle","angleBetweenTouch",0x57b5a691,"flixel.math.FlxAngle.angleBetweenTouch","flixel/math/FlxAngle.hx",184,0x32e99189)
...
bool AsDegrees = __o_AsDegrees.Default(false);
            	...
            	HX_STACK_ARG(AsDegrees,"AsDegrees")
HXLINE( 186)		HX_VARI(  ::flixel::math::FlxPoint,p) = Object->getScreenPosition(null(),null());
HXLINE( 188)		HX_VARI( Float,dx) = (Touch->screenX - p->x);
HXLINE( 189)		HX_VARI( Float,dy) = (Touch->screenY - p->y);
HXLINE( 191)		p->put();
...
HXLINE( 236)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get().StaticCast<  ::flixel::math::FlxPoint >()->set((int)0,(int)0);
...
HXLINE( 255)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get().StaticCast<  ::flixel::math::FlxPoint >()->set((int)0,(int)0);
