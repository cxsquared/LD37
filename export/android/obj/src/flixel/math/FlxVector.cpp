...
HXLINE( 294)			HX_VARI(  ::flixel::math::FlxVector,vector) = Dynamic( ::flixel::math::FlxVector_obj::_pool->get().StaticCast<  ::flixel::math::FlxVector >()->set((int)0,(int)0)).StaticCast<  ::flixel::math::FlxVector >();
...
HXLINE( 307)			HX_VARI(  ::flixel::math::FlxVector,vector) = Dynamic( ::flixel::math::FlxVector_obj::_pool->get().StaticCast<  ::flixel::math::FlxVector >()->set((int)0,(int)0)).StaticCast<  ::flixel::math::FlxVector >();
...
HXLINE( 343)			HX_VARI(  ::flixel::math::FlxVector,vector) = Dynamic( ::flixel::math::FlxVector_obj::_pool->get().StaticCast<  ::flixel::math::FlxVector >()->set((int)0,(int)0)).StaticCast<  ::flixel::math::FlxVector >();
...
HXLINE( 362)			HX_VARI(  ::flixel::math::FlxVector,vector) = Dynamic( ::flixel::math::FlxVector_obj::_pool->get().StaticCast<  ::flixel::math::FlxVector >()->set((int)0,(int)0)).StaticCast<  ::flixel::math::FlxVector >();
...
HXLINE( 409)			HX_VARI(  ::flixel::math::FlxVector,vector) = Dynamic( ::flixel::math::FlxVector_obj::_pool->get().StaticCast<  ::flixel::math::FlxVector >()->set((int)0,(int)0)).StaticCast<  ::flixel::math::FlxVector >();
...
HXLINE( 432)			HX_VARI(  ::flixel::math::FlxVector,vector) = Dynamic( ::flixel::math::FlxVector_obj::_pool->get().StaticCast<  ::flixel::math::FlxVector >()->set((int)0,(int)0)).StaticCast<  ::flixel::math::FlxVector >();
...
HXLINE( 568)			HX_VARI(  ::flixel::math::FlxVector,vector) = Dynamic( ::flixel::math::FlxVector_obj::_pool->get().StaticCast<  ::flixel::math::FlxVector >()->set((int)0,(int)0)).StaticCast<  ::flixel::math::FlxVector >();
...
Float FlxVector_obj::EPSILON_SQUARED;
 ...
 ::flixel::util::FlxPool FlxVector_obj::_pool;
...
Float Y = __o_Y.Default(0);
            	...
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
HXLINE(  28)		HX_VARI(  ::flixel::math::FlxVector,vector) = Dynamic( ::flixel::math::FlxVector_obj::_pool->get().StaticCast<  ::flixel::math::FlxVector >()->set(X,Y)).StaticCast<  ::flixel::math::FlxVector >();
...
static hx::StaticInfo FlxVector_obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::flixel::util::FlxPool*/ ,(void *) &FlxVector_obj::_pool,HX_HCSTRING("_pool","\xbb","\x9c","\x6d","\xfd")},
...
HXLINE(  13)		_pool =  ::flixel::util::FlxPool_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::math::FlxVector >());
            	}
{
