...
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_260_getObject_flixel_group_FlxTypedGroup_T,"flixel.math.FlxRandom","getObject_flixel_group_FlxTypedGroup_T",0x29a53b90,"flixel.math.FlxRandom.getObject_flixel_group_FlxTypedGroup_T","flixel/math/FlxRandom.hx",260,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_49_resetInitialSeed,"flixel.math.FlxRandom","resetInitialSeed",0xb48811f3,"flixel.math.FlxRandom.resetInitialSeed","flixel/math/FlxRandom.hx",49,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_63_int,"flixel.math.FlxRandom","int",0x97b12da2,"flixel.math.FlxRandom.int","flixel/math/FlxRandom.hx",63,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_110_float,"flixel.math.FlxRandom","float",0x0d07b90f,"flixel.math.FlxRandom.float","flixel/math/FlxRandom.hx",110,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_166_floatNormal,"flixel.math.FlxRandom","floatNormal",0xe3d85496,"flixel.math.FlxRandom.floatNormal","flixel/math/FlxRandom.hx",166,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_197_bool,"flixel.math.FlxRandom","bool",0x1eb70017,"flixel.math.FlxRandom.bool","flixel/math/FlxRandom.hx",197,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_209_sign,"flixel.math.FlxRandom","sign",0x29ef0c2a,"flixel.math.FlxRandom.sign","flixel/math/FlxRandom.hx",209,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_222_weightedPick,"flixel.math.FlxRandom","weightedPick",0x1c7c1545,"flixel.math.FlxRandom.weightedPick","flixel/math/FlxRandom.hx",222,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_357_color,"flixel.math.FlxRandom","color",0x54cd64d6,"flixel.math.FlxRandom.color","flixel/math/FlxRandom.hx",357,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_403_generate,"flixel.math.FlxRandom","generate",0xe00ed5a2,"flixel.math.FlxRandom.generate","flixel/math/FlxRandom.hx",403,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_418_set_initialSeed,"flixel.math.FlxRandom","set_initialSeed",0x5f4b69eb,"flixel.math.FlxRandom.set_initialSeed","flixel/math/FlxRandom.hx",418,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_426_get_currentSeed,"flixel.math.FlxRandom","get_currentSeed",0xbfecf714,"flixel.math.FlxRandom.get_currentSeed","flixel/math/FlxRandom.hx",426,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_434_set_currentSeed,"flixel.math.FlxRandom","set_currentSeed",0xbbb87420,"flixel.math.FlxRandom.set_currentSeed","flixel/math/FlxRandom.hx",434,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_442_rangeBound,"flixel.math.FlxRandom","rangeBound",0x5cf038ee,"flixel.math.FlxRandom.rangeBound","flixel/math/FlxRandom.hx",442,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_448_boot,"flixel.math.FlxRandom","boot",0x1eb7001f,"flixel.math.FlxRandom.boot","flixel/math/FlxRandom.hx",448,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_459_boot,"flixel.math.FlxRandom","boot",0x1eb7001f,"flixel.math.FlxRandom.boot","flixel/math/FlxRandom.hx",459,0x4fa37e1d)
HX_DEFINE_STACK_FRAME(_hx_pos_eba801adaf62ef5c_460_boot,"flixel.math.FlxRandom","boot",0x1eb7001f,"flixel.math.FlxRandom.boot","flixel/math/FlxRandom.hx",460,0x4fa37e1d)
namespace flixel{
namespace math{
...
HXDLIN(  32)			HX_VARI_NAME( int,NewSeed2,"NewSeed") = ::Std_obj::_hx_int(NewSeed1);
...
HXLINE(  36)			HX_VARI( int,Value) = ::Std_obj::_hx_int((::Math_obj::random() * (int)2147483647));
...
HXDLIN(  36)			HX_VARI_NAME( int,NewSeed4,"NewSeed") = ::Std_obj::_hx_int(NewSeed3);
...
HXDLIN(  36)			HX_VARI_NAME( int,NewSeed6,"NewSeed") = ::Std_obj::_hx_int(NewSeed5);
...
HXDLIN( 291)					_g3->push(WeightsArray->__get((_g21 - (int)1)));
            				}
            			}
...
int FlxRandom_obj::resetInitialSeed(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  49)		HX_VARI( int,Value) = ::Std_obj::_hx_int((::Math_obj::random() * (int)2147483647));
...
HXDLIN(  49)		HX_VARI_NAME( int,NewSeed1,"NewSeed") = ::Std_obj::_hx_int(NewSeed);
...
HXDLIN(  49)		HX_VARI_NAME( int,NewSeed3,"NewSeed") = ::Std_obj::_hx_int(NewSeed2);
...
HXLINE(  83)					return ::Math_obj::floor((Min + (((Float)(this->internalSeed = hx::Mod((this->internalSeed * ((Float)48271.0)),(int)2147483647)) / (Float)(int)2147483647) * ((Max - Min) + (int)1))));
            				}
            				else {
HXLINE(  87)					HX_VARI( int,result) = (int)0;
HXLINE(  89)					while(true){
HXLINE(  91)						result = ::Math_obj::floor((Min + (((Float)(this->internalSeed = hx::Mod((this->internalSeed * ((Float)48271.0)),(int)2147483647)) / (Float)(int)2147483647) * ((Max - Min) + (int)1))));
...
HXLINE( 133)					result = (Min + (((Float)(this->internalSeed = hx::Mod((this->internalSeed * ((Float)48271.0)),(int)2147483647)) / (Float)(int)2147483647) * (Max - Min)));
            				}
            				else {
HXLINE( 137)					while(true){
HXLINE( 139)						result = (Min + (((Float)(this->internalSeed = hx::Mod((this->internalSeed * ((Float)48271.0)),(int)2147483647)) / (Float)(int)2147483647) * (Max - Min)));
...
HXLINE( 176)		HX_VARI( Float,theta) = (this->_twoPI * ((Float)(this->internalSeed = hx::Mod((this->internalSeed * ((Float)48271.0)),(int)2147483647)) / (Float)(int)2147483647));
...
HXDLIN( 233)				HX_VARI_NAME( int,i1,"i") = (_g1 - (int)1);
...
HXDLIN( 418)		HX_VARI_NAME( int,NewSeed2,"NewSeed") = ::Std_obj::_hx_int(NewSeed1);
