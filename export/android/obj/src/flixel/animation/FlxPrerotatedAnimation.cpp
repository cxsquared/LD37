...
HX_DEFINE_STACK_FRAME(_hx_pos_2fc827bb1ad10643_25_set_angle,"flixel.animation.FlxPrerotatedAnimation","set_angle",0x23607fd0,"flixel.animation.FlxPrerotatedAnimation.set_angle","flixel/animation/FlxPrerotatedAnimation.hx",25,0x4a5f70b4)
HX_DEFINE_STACK_FRAME(_hx_pos_2fc827bb1ad10643_45_set_curIndex,"flixel.animation.FlxPrerotatedAnimation","set_curIndex",0x8ed63595,"flixel.animation.FlxPrerotatedAnimation.set_curIndex","flixel/animation/FlxPrerotatedAnimation.hx",45,0x4a5f70b4)
HX_DEFINE_STACK_FRAME(_hx_pos_2fc827bb1ad10643_58_clone,"flixel.animation.FlxPrerotatedAnimation","clone",0x470ab1f7,"flixel.animation.FlxPrerotatedAnimation.clone","flixel/animation/FlxPrerotatedAnimation.hx",58,0x4a5f70b4)
HX_DEFINE_STACK_FRAME(_hx_pos_2fc827bb1ad10643_9_boot,"flixel.animation.FlxPrerotatedAnimation","boot",0xc89036d8,"flixel.animation.FlxPrerotatedAnimation.boot","flixel/animation/FlxPrerotatedAnimation.hx",9,0x4a5f70b4)
namespace flixel{
namespace animation{
...
HXLINE(  34)		HX_VARI( int,newIndex) = ::Math_obj::floor((((Float)angleHelper / (Float)this->baked) + ((Float)0.5)));
...
HXLINE(  53)		return Value;
 ...
 ::flixel::animation::FlxBaseAnimation FlxPrerotatedAnimation_obj::clone( ::flixel::animation::FlxAnimationController Parent){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Parent,"Parent")
HXLINE(  58)		return  ::flixel::animation::FlxPrerotatedAnimation_obj::__alloc( HX_CTX ,Parent,this->baked);
            	}
