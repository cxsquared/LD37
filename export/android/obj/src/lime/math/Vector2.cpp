...
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_17_new,"lime.math.Vector2","new",0xaef3c434,"lime.math.Vector2.new","lime/math/Vector2.hx",17,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_27_add,"lime.math.Vector2","add",0xaee9e5f5,"lime.math.Vector2.add","lime/math/Vector2.hx",27,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_34_clone,"lime.math.Vector2","clone",0xd5c6a431,"lime.math.Vector2.clone","lime/math/Vector2.hx",34,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_50_equals,"lime.math.Vector2","equals",0xe9ae16eb,"lime.math.Vector2.equals","lime/math/Vector2.hx",50,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_64_normalize,"lime.math.Vector2","normalize",0xeaffc261,"lime.math.Vector2.normalize","lime/math/Vector2.hx",64,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_79_offset,"lime.math.Vector2","offset",0x89fac03f,"lime.math.Vector2.offset","lime/math/Vector2.hx",79,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_94_setTo,"lime.math.Vector2","setTo",0x07932291,"lime.math.Vector2.setTo","lime/math/Vector2.hx",94,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_103_subtract,"lime.math.Vector2","subtract",0x656920c0,"lime.math.Vector2.subtract","lime/math/Vector2.hx",103,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_113___toFlashPoint,"lime.math.Vector2","__toFlashPoint",0xf695b9a7,"lime.math.Vector2.__toFlashPoint","lime/math/Vector2.hx",113,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_128_get_length,"lime.math.Vector2","get_length",0xc2e9f35b,"lime.math.Vector2.get_length","lime/math/Vector2.hx",128,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_39_distance,"lime.math.Vector2","distance",0xd9513ee1,"lime.math.Vector2.distance","lime/math/Vector2.hx",39,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_57_interpolate,"lime.math.Vector2","interpolate",0xdb68bc95,"lime.math.Vector2.interpolate","lime/math/Vector2.hx",57,0x7105521c)
HX_DEFINE_STACK_FRAME(_hx_pos_c8980fb157cd0afb_89_polar,"lime.math.Vector2","polar",0x53f58092,"lime.math.Vector2.polar","lime/math/Vector2.hx",89,0x7105521c)
namespace lime{
namespace math{
...
Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_c8980fb157cd0afb_17_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(  19)		this->x = x;
...
bool Vector2_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::math::Vector2 Vector2_obj::add( ::lime::math::Vector2 v){
            	HX_GC_STACKFRAME(&_hx_pos_c8980fb157cd0afb_27_add)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE(  27)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(v->x + this->x),(v->y + this->y));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Vector2_obj,add,return )
 ...
 ::lime::math::Vector2 Vector2_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c8980fb157cd0afb_34_clone)
            	HX_STACK_THIS(this)
HXLINE(  34)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,this->x,this->y);
            	}
...
bool Vector2_obj::equals( ::lime::math::Vector2 toCompare){
            	HX_STACKFRAME(&_hx_pos_c8980fb157cd0afb_50_equals)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(toCompare,"toCompare")
HXLINE(  50)		bool _hx_tmp;
HXDLIN(  50)		if (hx::IsNotNull( toCompare )) {
...
void Vector2_obj::normalize(Float thickness){
            	HX_STACKFRAME(&_hx_pos_c8980fb157cd0afb_64_normalize)
            	HX_STACK_THIS(this)
...
HXLINE(  70)			HX_VARI( Float,norm) = ((Float)thickness / (Float)::Math_obj::sqrt(((this->x * this->x) + (this->y * this->y))));
HXLINE(  71)			 ::lime::math::Vector2 _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  71)			_hx_tmp1->x = (_hx_tmp1->x * norm);
HXLINE(  72)			 ::lime::math::Vector2 _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  72)			_hx_tmp2->y = (_hx_tmp2->y * norm);
            		}
            	}
...
void Vector2_obj::offset(Float dx,Float dy){
            	HX_STACKFRAME(&_hx_pos_c8980fb157cd0afb_79_offset)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE(  81)		 ::lime::math::Vector2 _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  81)		_hx_tmp->x = (_hx_tmp->x + dx);
HXLINE(  82)		 ::lime::math::Vector2 _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  82)		_hx_tmp1->y = (_hx_tmp1->y + dy);
            	}
...
void Vector2_obj::setTo(Float xa,Float ya){
            	HX_STACKFRAME(&_hx_pos_c8980fb157cd0afb_94_setTo)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xa,"xa")
            	HX_STACK_ARG(ya,"ya")
HXLINE(  96)		this->x = xa;
...
HX_DEFINE_DYNAMIC_FUNC2(Vector2_obj,setTo,(void))
 ...
 ::lime::math::Vector2 Vector2_obj::subtract( ::lime::math::Vector2 v){
            	HX_GC_STACKFRAME(&_hx_pos_c8980fb157cd0afb_103_subtract)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 103)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(this->x - v->x),(this->y - v->y));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Vector2_obj,subtract,return )
 ...
 ::Dynamic Vector2_obj::_hx___toFlashPoint(){
            	HX_STACKFRAME(&_hx_pos_c8980fb157cd0afb_113___toFlashPoint)
            	HX_STACK_THIS(this)
...
Float Vector2_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_c8980fb157cd0afb_128_get_length)
            	HX_STACK_THIS(this)
...
Float Vector2_obj::distance( ::lime::math::Vector2 pt1, ::lime::math::Vector2 pt2){
            	HX_STACKFRAME(&_hx_pos_c8980fb157cd0afb_39_distance)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Vector2_obj,distance,return )
 ...
 ::lime::math::Vector2 Vector2_obj::interpolate( ::lime::math::Vector2 pt1, ::lime::math::Vector2 pt2,Float f){
            	HX_GC_STACKFRAME(&_hx_pos_c8980fb157cd0afb_57_interpolate)
            	HX_STACK_ARG(pt1,"pt1")
            	HX_STACK_ARG(pt2,"pt2")
            	HX_STACK_ARG(f,"f")
HXLINE(  57)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(pt2->x + (f * (pt1->x - pt2->x))),(pt2->y + (f * (pt1->y - pt2->y))));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Vector2_obj,interpolate,return )
 ...
 ::lime::math::Vector2 Vector2_obj::polar(Float len,Float angle){
            	HX_GC_STACKFRAME(&_hx_pos_c8980fb157cd0afb_89_polar)
            	HX_STACK_ARG(len,"len")
            	HX_STACK_ARG(angle,"angle")
HXLINE(  89)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(len * ::Math_obj::cos(angle)),(len * ::Math_obj::sin(angle)));
            	}
