...
HX_DEFINE_STACK_FRAME(_hx_pos_c51b2e87fb75d55f_23_new,"lime.ui.Touch","new",0xc7f37270,"lime.ui.Touch.new","lime/ui/Touch.hx",23,0xf69781a0)
HX_DEFINE_STACK_FRAME(_hx_pos_c51b2e87fb75d55f_10_boot,"lime.ui.Touch","boot",0x2529b022,"lime.ui.Touch.boot","lime/ui/Touch.hx",10,0xf69781a0)
HX_DEFINE_STACK_FRAME(_hx_pos_c51b2e87fb75d55f_11_boot,"lime.ui.Touch","boot",0x2529b022,"lime.ui.Touch.boot","lime/ui/Touch.hx",11,0xf69781a0)
HX_DEFINE_STACK_FRAME(_hx_pos_c51b2e87fb75d55f_12_boot,"lime.ui.Touch","boot",0x2529b022,"lime.ui.Touch.boot","lime/ui/Touch.hx",12,0xf69781a0)
namespace lime{
namespace ui{

void Touch_obj::__construct(Float x,Float y,int id,Float dx,Float dy,Float pressure,int device){
            	HX_STACKFRAME(&_hx_pos_c51b2e87fb75d55f_23_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(id,"id")
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_c51b2e87fb75d55f_10_boot)
HXLINE(  10)		onEnd =  ::lime::app::Event_lime_ui_Touch_Void_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_c51b2e87fb75d55f_11_boot)
HXLINE(  11)		onMove =  ::lime::app::Event_lime_ui_Touch_Void_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_c51b2e87fb75d55f_12_boot)
HXLINE(  12)		onStart =  ::lime::app::Event_lime_ui_Touch_Void_obj::__alloc( HX_CTX );
            	}
}
