...
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_79_get_guid,"lime.ui.Gamepad","get_guid",0x2f6ca220,"lime.ui.Gamepad.get_guid","lime/ui/Gamepad.hx",79,0x36bc843e)
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_93_get_name,"lime.ui.Gamepad","get_name",0x33fdf6e2,"lime.ui.Gamepad.get_name","lime/ui/Gamepad.hx",93,0x36bc843e)
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_40_addMappings,"lime.ui.Gamepad","addMappings",0x7dce3c98,"lime.ui.Gamepad.addMappings","lime/ui/Gamepad.hx",40,0x36bc843e)
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_48___connect,"lime.ui.Gamepad","__connect",0x06daaffc,"lime.ui.Gamepad.__connect","lime/ui/Gamepad.hx",48,0x36bc843e)
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_59___disconnect,"lime.ui.Gamepad","__disconnect",0x04d0478a,"lime.ui.Gamepad.__disconnect","lime/ui/Gamepad.hx",59,0x36bc843e)
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_112_lime_gamepad_add_mappings,"lime.ui.Gamepad","lime_gamepad_add_mappings",0x0a0a603d,"lime.ui.Gamepad.lime_gamepad_add_mappings","lime/ui/Gamepad.hx",112,0x36bc843e)
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_113_lime_gamepad_get_device_guid,"lime.ui.Gamepad","lime_gamepad_get_device_guid",0x36bce76f,"lime.ui.Gamepad.lime_gamepad_get_device_guid","lime/ui/Gamepad.hx",113,0x36bc843e)
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_114_lime_gamepad_get_device_name,"lime.ui.Gamepad","lime_gamepad_get_device_name",0x3b4e3c31,"lime.ui.Gamepad.lime_gamepad_get_device_name","lime/ui/Gamepad.hx",114,0x36bc843e)
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_16_boot,"lime.ui.Gamepad","boot",0xb1262e40,"lime.ui.Gamepad.boot","lime/ui/Gamepad.hx",16,0x36bc843e)
HX_DEFINE_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_17_boot,"lime.ui.Gamepad","boot",0xb1262e40,"lime.ui.Gamepad.boot","lime/ui/Gamepad.hx",17,0x36bc843e)
namespace lime{
namespace ui{
...
void Gamepad_obj::__construct(int id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  26)		this->onDisconnect =  ::lime::app::Event_Void_Void_obj::__alloc( HX_CTX );
HXLINE(  25)		this->onButtonUp =  ::lime::app::Event_lime_ui_GamepadButton_Void_obj::__alloc( HX_CTX );
HXLINE(  24)		this->onButtonDown =  ::lime::app::Event_lime_ui_GamepadButton_Void_obj::__alloc( HX_CTX );
HXLINE(  23)		this->onAxisMove =  ::lime::app::Event_lime_ui_GamepadAxis_Float_Void_obj::__alloc( HX_CTX );
...
::String Gamepad_obj::get_guid(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_79_get_guid)
            	HX_STACK_THIS(this)
...
::String Gamepad_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_93_get_name)
            	HX_STACK_THIS(this)
...
void Gamepad_obj::addMappings(::Array< ::String > mappings){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_40_addMappings)
...
void Gamepad_obj::_hx___connect(int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE(  48)		if (!(::lime::ui::Gamepad_obj::devices->exists(id))) {
HXLINE(  50)			HX_VARI(  ::lime::ui::Gamepad,gamepad) =  ::lime::ui::Gamepad_obj::__alloc( HX_CTX ,id);
...
void Gamepad_obj::lime_gamepad_add_mappings( ::Dynamic mappings){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_112_lime_gamepad_add_mappings)
            	HX_STACK_ARG(mappings,"mappings")
HXLINE( 112)		return;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Gamepad_obj,lime_gamepad_add_mappings,(void))
 ...
 ::Dynamic Gamepad_obj::lime_gamepad_get_device_guid(int id){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_113_lime_gamepad_get_device_guid)
            	HX_STACK_ARG(id,"id")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Gamepad_obj,lime_gamepad_get_device_guid,return )
 ...
 ::Dynamic Gamepad_obj::lime_gamepad_get_device_name(int id){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_114_lime_gamepad_get_device_name)
            	HX_STACK_ARG(id,"id")
...
HXLINE(  16)		devices =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_17_boot)
HXLINE(  17)		onConnect =  ::lime::app::Event_lime_ui_Gamepad_Void_obj::__alloc( HX_CTX );
            	}
}
