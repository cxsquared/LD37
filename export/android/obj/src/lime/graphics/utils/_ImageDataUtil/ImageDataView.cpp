...
HX_DEFINE_STACK_FRAME(_hx_pos_ca97c355311e00fd_1302_new,"lime.graphics.utils._ImageDataUtil.ImageDataView","new",0xaa0478bd,"lime.graphics.utils._ImageDataUtil.ImageDataView.new","lime/graphics/utils/ImageDataUtil.hx",1302,0x494d921f)
HX_DEFINE_STACK_FRAME(_hx_pos_ca97c355311e00fd_1333_clip,"lime.graphics.utils._ImageDataUtil.ImageDataView","clip",0x12a517d3,"lime.graphics.utils._ImageDataUtil.ImageDataView.clip","lime/graphics/utils/ImageDataUtil.hx",1333,0x494d921f)
HX_DEFINE_STACK_FRAME(_hx_pos_ca97c355311e00fd_1348_row,"lime.graphics.utils._ImageDataUtil.ImageDataView","row",0xaa078a77,"lime.graphics.utils._ImageDataUtil.ImageDataView.row","lime/graphics/utils/ImageDataUtil.hx",1348,0x494d921f)
namespace lime{
namespace graphics{
namespace utils{
...
void ImageDataView_obj::__construct( ::lime::graphics::Image image, ::lime::math::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1302_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(image,"image")
            	HX_STACK_ARG(rect,"rect")
HXLINE(1304)		this->image = image;
HXLINE(1306)		if (hx::IsNull( rect )) {
HXLINE(1308)			this->rect = image->get_rect();
            		}
            		else {
HXLINE(1312)			if ((rect->x < (int)0)) {
HXLINE(1312)				rect->x = (int)0;
            			}
HXLINE(1313)			if ((rect->y < (int)0)) {
HXLINE(1313)				rect->y = (int)0;
            			}
HXLINE(1314)			if (((rect->x + rect->width) > image->width)) {
HXLINE(1314)				rect->width = (image->width - rect->x);
            			}
HXLINE(1315)			if (((rect->y + rect->height) > image->height)) {
HXLINE(1315)				rect->height = (image->height - rect->y);
            			}
HXLINE(1316)			if ((rect->width < (int)0)) {
HXLINE(1316)				rect->width = (int)0;
            			}
HXLINE(1317)			if ((rect->height < (int)0)) {
...
HXLINE(1328)		this->offset = ((this->stride * (this->y + image->offsetY)) + ((this->x + image->offsetX) * (int)4));
            	}
...
void ImageDataView_obj::clip(int x,int y,int width,int height){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1333_clip)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
HXLINE(1341)		this->offset = ((this->stride * (this->y + this->image->offsetY)) + ((this->x + this->image->offsetX) * (int)4));
            	}
...
int ImageDataView_obj::row(int y){
            	HX_STACKFRAME(&_hx_pos_ca97c355311e00fd_1348_row)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(y,"y")
