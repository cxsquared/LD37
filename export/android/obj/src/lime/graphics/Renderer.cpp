...
HX_DEFINE_STACK_FRAME(_hx_pos_967f36da67cfd2f5_9_new,"lime.graphics.Renderer","new",0x7185ed3f,"lime.graphics.Renderer.new","lime/graphics/Renderer.hx",9,0x16f09331)
HX_DEFINE_STACK_FRAME(_hx_pos_967f36da67cfd2f5_35_create,"lime.graphics.Renderer","create",0x6b7d5f7d,"lime.graphics.Renderer.create","lime/graphics/Renderer.hx",35,0x16f09331)
HX_DEFINE_STACK_FRAME(_hx_pos_967f36da67cfd2f5_42_flip,"lime.graphics.Renderer","flip",0xde6538ee,"lime.graphics.Renderer.flip","lime/graphics/Renderer.hx",42,0x16f09331)
HX_DEFINE_STACK_FRAME(_hx_pos_967f36da67cfd2f5_49_readPixels,"lime.graphics.Renderer","readPixels",0xd6a0a024,"lime.graphics.Renderer.readPixels","lime/graphics/Renderer.hx",49,0x16f09331)
HX_DEFINE_STACK_FRAME(_hx_pos_967f36da67cfd2f5_56_render,"lime.graphics.Renderer","render",0xf49763d7,"lime.graphics.Renderer.render","lime/graphics/Renderer.hx",56,0x16f09331)
namespace lime{
namespace graphics{

void Renderer_obj::__construct( ::lime::ui::Window window){
            	HX_GC_STACKFRAME(&_hx_pos_967f36da67cfd2f5_9_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(window,"window")
HXLINE(  15)		this->onRender =  ::lime::app::Event_Void_Void_obj::__alloc( HX_CTX );
HXLINE(  14)		this->onContextRestored =  ::lime::app::Event_lime_graphics_RenderContext_Void_obj::__alloc( HX_CTX );
HXLINE(  13)		this->onContextLost =  ::lime::app::Event_Void_Void_obj::__alloc( HX_CTX );
HXLINE(  24)		this->window = window;
HXLINE(  26)		this->backend =  ::lime::_backend::native::NativeRenderer_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
...
void Renderer_obj::create(){
            	HX_STACKFRAME(&_hx_pos_967f36da67cfd2f5_35_create)
            	HX_STACK_THIS(this)
...
void Renderer_obj::flip(){
            	HX_STACKFRAME(&_hx_pos_967f36da67cfd2f5_42_flip)
            	HX_STACK_THIS(this)
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Renderer_obj,flip,(void))
 ...
 ::lime::graphics::Image Renderer_obj::readPixels( ::lime::math::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_967f36da67cfd2f5_49_readPixels)
            	HX_STACK_THIS(this)
...
void Renderer_obj::render(){
            	HX_STACKFRAME(&_hx_pos_967f36da67cfd2f5_56_render)
            	HX_STACK_THIS(this)
