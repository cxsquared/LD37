...
HX_DEFINE_STACK_FRAME(_hx_pos_0a62cc2bc659c459_10_new,"lime.graphics.opengl.GLProgram","new",0x2d826a7c,"lime.graphics.opengl.GLProgram.new","lime/graphics/opengl/GLProgram.hx",10,0x48d7ea15)
HX_DEFINE_STACK_FRAME(_hx_pos_0a62cc2bc659c459_20_attach,"lime.graphics.opengl.GLProgram","attach",0x80ff9b29,"lime.graphics.opengl.GLProgram.attach","lime/graphics/opengl/GLProgram.hx",20,0x48d7ea15)
HX_DEFINE_STACK_FRAME(_hx_pos_0a62cc2bc659c459_27_getShaders,"lime.graphics.opengl.GLProgram","getShaders",0x3da5291c,"lime.graphics.opengl.GLProgram.getShaders","lime/graphics/opengl/GLProgram.hx",27,0x48d7ea15)
HX_DEFINE_STACK_FRAME(_hx_pos_0a62cc2bc659c459_34_getType,"lime.graphics.opengl.GLProgram","getType",0x50477a8c,"lime.graphics.opengl.GLProgram.getType","lime/graphics/opengl/GLProgram.hx",34,0x48d7ea15)
namespace lime{
namespace graphics{
namespace opengl{

void GLProgram_obj::__construct(int version, ::Dynamic id){
            	HX_STACKFRAME(&_hx_pos_0a62cc2bc659c459_10_new)
            	HX_STACK_THIS(this)
...
void GLProgram_obj::attach( ::lime::graphics::opengl::GLShader shader){
            	HX_STACKFRAME(&_hx_pos_0a62cc2bc659c459_20_attach)
            	HX_STACK_THIS(this)
...
::Array< ::Dynamic> GLProgram_obj::getShaders(){
            	HX_STACKFRAME(&_hx_pos_0a62cc2bc659c459_27_getShaders)
            	HX_STACK_THIS(this)
...
::String GLProgram_obj::getType(){
            	HX_STACKFRAME(&_hx_pos_0a62cc2bc659c459_34_getType)
            	HX_STACK_THIS(this)
