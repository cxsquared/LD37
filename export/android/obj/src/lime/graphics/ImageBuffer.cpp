...
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_43_new,"lime.graphics.ImageBuffer","new",0xb261c9e3,"lime.graphics.ImageBuffer.new","lime/graphics/ImageBuffer.hx",43,0x6475c2cd)
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_55_clone,"lime.graphics.ImageBuffer","clone",0x1504b3a0,"lime.graphics.ImageBuffer.clone","lime/graphics/ImageBuffer.hx",55,0x6475c2cd)
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_139_get_src,"lime.graphics.ImageBuffer","get_src",0x9748e67e,"lime.graphics.ImageBuffer.get_src","lime/graphics/ImageBuffer.hx",139,0x6475c2cd)
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_146_set_src,"lime.graphics.ImageBuffer","set_src",0x8a4a778a,"lime.graphics.ImageBuffer.set_src","lime/graphics/ImageBuffer.hx",146,0x6475c2cd)
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_178_get_stride,"lime.graphics.ImageBuffer","get_stride",0xb11b1cbf,"lime.graphics.ImageBuffer.get_stride","lime/graphics/ImageBuffer.hx",178,0x6475c2cd)
namespace lime{
namespace graphics{
...
int bitsPerPixel = __o_bitsPerPixel.Default(32);
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_43_new)
            	HX_STACK_THIS(this)
...
bool ImageBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::ImageBuffer ImageBuffer_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_890299056ccc780d_55_clone)
            	HX_STACK_THIS(this)
HXLINE(  57)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this->data,this->width,this->height,this->bitsPerPixel,null());
HXLINE( 101)		if (hx::IsNotNull( this->data )) {
...
HXDLIN( 105)			if (hx::IsNotNull( bytes )) {
HXLINE( 105)				HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
...
HXDLIN( 105)				_this->length = ::Std_obj::_hx_int(((Float)bufferByteLength / (Float)_this->bytesPerElement));
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,clone,return )
 ...
 ::Dynamic ImageBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_139_get_src)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,get_src,return )
 ...
 ::Dynamic ImageBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_146_set_src)
            	HX_STACK_THIS(this)
...
int ImageBuffer_obj::get_stride(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_178_get_stride)
            	HX_STACK_THIS(this)
