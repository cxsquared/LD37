...
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_333_new,"lime.graphics.ConsoleRenderContext","new",0x37aa2dde,"lime.graphics.ConsoleRenderContext.new","lime/graphics/ConsoleRenderContext.hx",333,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_343_createIndexBuffer,"lime.graphics.ConsoleRenderContext","createIndexBuffer",0x26fefe14,"lime.graphics.ConsoleRenderContext.createIndexBuffer","lime/graphics/ConsoleRenderContext.hx",343,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_344_createVertexBuffer,"lime.graphics.ConsoleRenderContext","createVertexBuffer",0x6cd66ce2,"lime.graphics.ConsoleRenderContext.createVertexBuffer","lime/graphics/ConsoleRenderContext.hx",344,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_345_lookupShader,"lime.graphics.ConsoleRenderContext","lookupShader",0xafa7f001,"lime.graphics.ConsoleRenderContext.lookupShader","lime/graphics/ConsoleRenderContext.hx",345,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_347_clear,"lime.graphics.ConsoleRenderContext","clear",0xc822aa8b,"lime.graphics.ConsoleRenderContext.clear","lime/graphics/ConsoleRenderContext.hx",347,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_349_bindShader,"lime.graphics.ConsoleRenderContext","bindShader",0xbefe0304,"lime.graphics.ConsoleRenderContext.bindShader","lime/graphics/ConsoleRenderContext.hx",349,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_351_setViewport,"lime.graphics.ConsoleRenderContext","setViewport",0xd05321a6,"lime.graphics.ConsoleRenderContext.setViewport","lime/graphics/ConsoleRenderContext.hx",351,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_353_setVertexShaderConstantF,"lime.graphics.ConsoleRenderContext","setVertexShaderConstantF",0xee598a39,"lime.graphics.ConsoleRenderContext.setVertexShaderConstantF","lime/graphics/ConsoleRenderContext.hx",353,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_355_setVertexSource,"lime.graphics.ConsoleRenderContext","setVertexSource",0x13a8189f,"lime.graphics.ConsoleRenderContext.setVertexSource","lime/graphics/ConsoleRenderContext.hx",355,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_356_setIndexSource,"lime.graphics.ConsoleRenderContext","setIndexSource",0xe2764c4d,"lime.graphics.ConsoleRenderContext.setIndexSource","lime/graphics/ConsoleRenderContext.hx",356,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_358_draw,"lime.graphics.ConsoleRenderContext","draw",0x76ab9cc6,"lime.graphics.ConsoleRenderContext.draw","lime/graphics/ConsoleRenderContext.hx",358,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_359_drawIndexed,"lime.graphics.ConsoleRenderContext","drawIndexed",0x2d54abcb,"lime.graphics.ConsoleRenderContext.drawIndexed","lime/graphics/ConsoleRenderContext.hx",359,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_361_get_width,"lime.graphics.ConsoleRenderContext","get_width",0x2d96a25b,"lime.graphics.ConsoleRenderContext.get_width","lime/graphics/ConsoleRenderContext.hx",361,0x16233b72)
HX_DEFINE_STACK_FRAME(_hx_pos_4f71ceec478c13c6_362_get_height,"lime.graphics.ConsoleRenderContext","get_height",0x6c86e5f2,"lime.graphics.ConsoleRenderContext.get_height","lime/graphics/ConsoleRenderContext.hx",362,0x16233b72)
namespace lime{
namespace graphics{

void ConsoleRenderContext_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_333_new)
            	HX_STACK_THIS(this)
            	}
...
bool ConsoleRenderContext_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::console::IndexBuffer ConsoleRenderContext_obj::createIndexBuffer( ::Dynamic indices,int count){
            	HX_GC_STACKFRAME(&_hx_pos_4f71ceec478c13c6_343_createIndexBuffer)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(indices,"indices")
            	HX_STACK_ARG(count,"count")
HXLINE( 343)		return  ::lime::graphics::console::IndexBuffer_obj::__alloc( HX_CTX );
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(ConsoleRenderContext_obj,createIndexBuffer,return )
 ...
 ::lime::graphics::console::VertexBuffer ConsoleRenderContext_obj::createVertexBuffer( ::Dynamic decl,int count){
            	HX_GC_STACKFRAME(&_hx_pos_4f71ceec478c13c6_344_createVertexBuffer)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(decl,"decl")
            	HX_STACK_ARG(count,"count")
HXLINE( 344)		return  ::lime::graphics::console::VertexBuffer_obj::__alloc( HX_CTX );
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(ConsoleRenderContext_obj,createVertexBuffer,return )
 ...
 ::lime::graphics::console::Shader ConsoleRenderContext_obj::lookupShader(::String name){
            	HX_GC_STACKFRAME(&_hx_pos_4f71ceec478c13c6_345_lookupShader)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE( 345)		return  ::lime::graphics::console::Shader_obj::__alloc( HX_CTX );
            	}
...
int stencil = __o_stencil.Default(0);
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_347_clear)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(r,"r")
            	HX_STACK_ARG(g,"g")
            	HX_STACK_ARG(b,"b")
...
void ConsoleRenderContext_obj::bindShader( ::lime::graphics::console::Shader shader){
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_349_bindShader)
            	HX_STACK_THIS(this)
...
Float farPlane = __o_farPlane.Default(((Float)1.0));
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_351_setViewport)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
...
void ConsoleRenderContext_obj::setVertexShaderConstantF( ::Dynamic startRegister, ::Dynamic vec4, ::Dynamic vec4count){
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_353_setVertexShaderConstantF)
            	HX_STACK_THIS(this)
...
void ConsoleRenderContext_obj::setVertexSource( ::lime::graphics::console::VertexBuffer vb){
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_355_setVertexSource)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(vb,"vb")
            	}
...
void ConsoleRenderContext_obj::setIndexSource( ::lime::graphics::console::IndexBuffer ib){
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_356_setIndexSource)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ib,"ib")
            	}
...
void ConsoleRenderContext_obj::draw( ::Dynamic primitive, ::Dynamic startVertex, ::Dynamic primitiveCount){
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_358_draw)
            	HX_STACK_THIS(this)
...
void ConsoleRenderContext_obj::drawIndexed( ::Dynamic primitive, ::Dynamic vertexCount, ::Dynamic startIndex, ::Dynamic primitiveCount){
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_359_drawIndexed)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(primitive,"primitive")
...
int ConsoleRenderContext_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_361_get_width)
            	HX_STACK_THIS(this)
...
int ConsoleRenderContext_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_4f71ceec478c13c6_362_get_height)
            	HX_STACK_THIS(this)
