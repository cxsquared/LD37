...
HX_DEFINE_STACK_FRAME(_hx_pos_4be9d6956d8ea946_812_new,"lime._backend.native._NativeApplication.KeyEventInfo","new",0x9d1330f8,"lime._backend.native._NativeApplication.KeyEventInfo.new","lime/_backend/native/NativeApplication.hx",812,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_4be9d6956d8ea946_824_clone,"lime._backend.native._NativeApplication.KeyEventInfo","clone",0x1c2dc9f5,"lime._backend.native._NativeApplication.KeyEventInfo.clone","lime/_backend/native/NativeApplication.hx",824,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int modifier = __o_modifier.Default(0);
            	HX_STACKFRAME(&_hx_pos_4be9d6956d8ea946_812_new)
            	HX_STACK_THIS(this)
...
bool KeyEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::KeyEventInfo KeyEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_4be9d6956d8ea946_824_clone)
            	HX_STACK_THIS(this)
HXLINE( 824)		return  ::lime::_backend::native::_NativeApplication::KeyEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->keyCode,this->modifier);
            	}
