...
HX_DEFINE_STACK_FRAME(_hx_pos_7f39e850c253c633_893_new,"lime._backend.native._NativeApplication.RenderEventInfo","new",0xcf12fe07,"lime._backend.native._NativeApplication.RenderEventInfo.new","lime/_backend/native/NativeApplication.hx",893,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_7f39e850c253c633_903_clone,"lime._backend.native._NativeApplication.RenderEventInfo","clone",0xa78638c4,"lime._backend.native._NativeApplication.RenderEventInfo.clone","lime/_backend/native/NativeApplication.hx",903,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
void RenderEventInfo_obj::__construct( ::Dynamic type, ::lime::graphics::RenderContext context){
            	HX_STACKFRAME(&_hx_pos_7f39e850c253c633_893_new)
            	HX_STACK_THIS(this)
...
bool RenderEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::RenderEventInfo RenderEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_7f39e850c253c633_903_clone)
            	HX_STACK_THIS(this)
HXLINE( 903)		return  ::lime::_backend::native::_NativeApplication::RenderEventInfo_obj::__alloc( HX_CTX ,this->type,this->context);
            	}
