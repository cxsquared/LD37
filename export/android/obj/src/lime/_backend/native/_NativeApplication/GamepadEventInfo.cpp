...
HX_DEFINE_STACK_FRAME(_hx_pos_3b7a66bddb205621_725_new,"lime._backend.native._NativeApplication.GamepadEventInfo","new",0xafb72336,"lime._backend.native._NativeApplication.GamepadEventInfo.new","lime/_backend/native/NativeApplication.hx",725,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_3b7a66bddb205621_738_clone,"lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",738,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float value = __o_value.Default(0);
            	HX_STACKFRAME(&_hx_pos_3b7a66bddb205621_725_new)
            	HX_STACK_THIS(this)
...
bool GamepadEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3b7a66bddb205621_738_clone)
            	HX_STACK_THIS(this)
HXLINE( 738)		return  ::lime::_backend::native::_NativeApplication::GamepadEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->button,this->axis,this->value);
            	}
