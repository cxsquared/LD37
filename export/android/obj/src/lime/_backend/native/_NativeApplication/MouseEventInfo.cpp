...
HX_DEFINE_STACK_FRAME(_hx_pos_e3566ee739d748b6_853_new,"lime._backend.native._NativeApplication.MouseEventInfo","new",0x1e4161f2,"lime._backend.native._NativeApplication.MouseEventInfo.new","lime/_backend/native/NativeApplication.hx",853,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_e3566ee739d748b6_868_clone,"lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",868,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float movementY = __o_movementY.Default(0);
            	HX_STACKFRAME(&_hx_pos_e3566ee739d748b6_853_new)
            	HX_STACK_THIS(this)
...
bool MouseEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e3566ee739d748b6_868_clone)
            	HX_STACK_THIS(this)
HXLINE( 868)		return  ::lime::_backend::native::_NativeApplication::MouseEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
