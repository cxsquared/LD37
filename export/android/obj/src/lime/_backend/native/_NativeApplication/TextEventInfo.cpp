...
HX_DEFINE_STACK_FRAME(_hx_pos_d4a11b6fb4b30fe3_969_new,"lime._backend.native._NativeApplication.TextEventInfo","new",0xb1ead390,"lime._backend.native._NativeApplication.TextEventInfo.new","lime/_backend/native/NativeApplication.hx",969,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_d4a11b6fb4b30fe3_982_clone,"lime._backend.native._NativeApplication.TextEventInfo","clone",0xd025428d,"lime._backend.native._NativeApplication.TextEventInfo.clone","lime/_backend/native/NativeApplication.hx",982,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int length = __o_length.Default(0);
            	HX_STACKFRAME(&_hx_pos_d4a11b6fb4b30fe3_969_new)
            	HX_STACK_THIS(this)
...
bool TextEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::TextEventInfo TextEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_d4a11b6fb4b30fe3_982_clone)
            	HX_STACK_THIS(this)
HXLINE( 982)		return  ::lime::_backend::native::_NativeApplication::TextEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->text,this->start,this->length);
            	}
