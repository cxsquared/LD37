...
HX_DEFINE_STACK_FRAME(_hx_pos_a59bd2e504ea207a_1055_new,"lime._backend.native._NativeApplication.WindowEventInfo","new",0xd11afd2d,"lime._backend.native._NativeApplication.WindowEventInfo.new","lime/_backend/native/NativeApplication.hx",1055,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_a59bd2e504ea207a_1069_clone,"lime._backend.native._NativeApplication.WindowEventInfo","clone",0x3ae8cd6a,"lime._backend.native._NativeApplication.WindowEventInfo.clone","lime/_backend/native/NativeApplication.hx",1069,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_a59bd2e504ea207a_1055_new)
            	HX_STACK_THIS(this)
...
bool WindowEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a59bd2e504ea207a_1069_clone)
            	HX_STACK_THIS(this)
HXLINE(1069)		return  ::lime::_backend::native::_NativeApplication::WindowEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
