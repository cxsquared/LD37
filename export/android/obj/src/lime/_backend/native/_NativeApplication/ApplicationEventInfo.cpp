...
HX_DEFINE_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_657_new,"lime._backend.native._NativeApplication.ApplicationEventInfo","new",0x285f59a7,"lime._backend.native._NativeApplication.ApplicationEventInfo.new","lime/_backend/native/NativeApplication.hx",657,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_667_clone,"lime._backend.native._NativeApplication.ApplicationEventInfo","clone",0x3158bc64,"lime._backend.native._NativeApplication.ApplicationEventInfo.clone","lime/_backend/native/NativeApplication.hx",667,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int deltaTime = __o_deltaTime.Default(0);
            	HX_STACKFRAME(&_hx_pos_e0c2b4da9d832f26_657_new)
            	HX_STACK_THIS(this)
...
bool ApplicationEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::ApplicationEventInfo ApplicationEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e0c2b4da9d832f26_667_clone)
            	HX_STACK_THIS(this)
HXLINE( 667)		return  ::lime::_backend::native::_NativeApplication::ApplicationEventInfo_obj::__alloc( HX_CTX ,this->type,this->deltaTime);
            	}
