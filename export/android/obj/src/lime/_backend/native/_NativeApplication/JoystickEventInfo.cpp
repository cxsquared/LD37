...
HX_DEFINE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_768_new,"lime._backend.native._NativeApplication.JoystickEventInfo","new",0x2df84fa1,"lime._backend.native._NativeApplication.JoystickEventInfo.new","lime/_backend/native/NativeApplication.hx",768,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_782_clone,"lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",782,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4c8f67ddac45293c_768_new)
            	HX_STACK_THIS(this)
...
bool JoystickEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_4c8f67ddac45293c_782_clone)
            	HX_STACK_THIS(this)
HXLINE( 782)		return  ::lime::_backend::native::_NativeApplication::JoystickEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->index,this->value,this->x,this->y);
            	}
