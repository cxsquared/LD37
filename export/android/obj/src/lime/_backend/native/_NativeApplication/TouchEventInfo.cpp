...
HX_DEFINE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1011_new,"lime._backend.native._NativeApplication.TouchEventInfo","new",0x974ae818,"lime._backend.native._NativeApplication.TouchEventInfo.new","lime/_backend/native/NativeApplication.hx",1011,0xb13849fd)
HX_DEFINE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1027_clone,"lime._backend.native._NativeApplication.TouchEventInfo","clone",0xdd198915,"lime._backend.native._NativeApplication.TouchEventInfo.clone","lime/_backend/native/NativeApplication.hx",1027,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
bool TouchEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1027_clone)
            	HX_STACK_THIS(this)
HXLINE(1027)		return  ::lime::_backend::native::_NativeApplication::TouchEventInfo_obj::__alloc( HX_CTX ,this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
