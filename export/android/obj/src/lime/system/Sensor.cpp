...
HX_DEFINE_STACK_FRAME(_hx_pos_f882df2140418079_7_new,"lime.system.Sensor","new",0xd4cfafd2,"lime.system.Sensor.new","lime/system/Sensor.hx",7,0x7b4cf9be)
HX_DEFINE_STACK_FRAME(_hx_pos_f882df2140418079_28_getSensors,"lime.system.Sensor","getSensors",0xecc219d1,"lime.system.Sensor.getSensors","lime/system/Sensor.hx",28,0x7b4cf9be)
HX_DEFINE_STACK_FRAME(_hx_pos_f882df2140418079_53_registerSensor,"lime.system.Sensor","registerSensor",0x90f30acb,"lime.system.Sensor.registerSensor","lime/system/Sensor.hx",53,0x7b4cf9be)
HX_DEFINE_STACK_FRAME(_hx_pos_f882df2140418079_10_boot,"lime.system.Sensor","boot",0x59032880,"lime.system.Sensor.boot","lime/system/Sensor.hx",10,0x7b4cf9be)
HX_DEFINE_STACK_FRAME(_hx_pos_f882df2140418079_11_boot,"lime.system.Sensor","boot",0x59032880,"lime.system.Sensor.boot","lime/system/Sensor.hx",11,0x7b4cf9be)
namespace lime{
namespace _hx_system{

void Sensor_obj::__construct( ::lime::_hx_system::SensorType type,int id){
            	HX_GC_STACKFRAME(&_hx_pos_f882df2140418079_7_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(id,"id")
HXLINE(  14)		this->onUpdate =  ::lime::app::Event_Float_Float_Float_Void_obj::__alloc( HX_CTX );
...
::Array< ::Dynamic> Sensor_obj::getSensors( ::lime::_hx_system::SensorType type){
            	HX_STACKFRAME(&_hx_pos_f882df2140418079_28_getSensors)
            	HX_STACK_ARG(type,"type")
HXLINE(  28)		if (hx::IsNull( type )) {
...
void Sensor_obj::registerSensor( ::lime::_hx_system::SensorType type,int id){
            	HX_GC_STACKFRAME(&_hx_pos_f882df2140418079_53_registerSensor)
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(id,"id")
HXLINE(  55)		HX_VARI(  ::lime::_hx_system::Sensor,sensor) =  ::lime::_hx_system::Sensor_obj::__alloc( HX_CTX ,type,id);
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_f882df2140418079_10_boot)
HXLINE(  10)		sensorByID =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_f882df2140418079_11_boot)
