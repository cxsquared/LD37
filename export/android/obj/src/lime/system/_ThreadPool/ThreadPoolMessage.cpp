...
HX_DEFINE_STACK_FRAME(_hx_pos_bb5354c74457ff34_230_new,"lime.system._ThreadPool.ThreadPoolMessage","new",0x973bef04,"lime.system._ThreadPool.ThreadPoolMessage.new","lime/system/ThreadPool.hx",230,0x8993fbb2)
namespace lime{
...
void ThreadPoolMessage_obj::__construct( ::lime::_hx_system::_ThreadPool::ThreadPoolMessageType type, ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_bb5354c74457ff34_230_new)
            	HX_STACK_THIS(this)
