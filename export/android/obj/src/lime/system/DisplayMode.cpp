...
HX_DEFINE_STACK_FRAME(_hx_pos_bad5236c57cf1a4a_31_new,"lime.system.DisplayMode","new",0x2251a8d1,"lime.system.DisplayMode.new","lime/system/DisplayMode.hx",31,0xb4b505df)
namespace lime{
namespace _hx_system{

void DisplayMode_obj::__construct(int width,int height,int refreshRate,int pixelFormat){
            	HX_STACKFRAME(&_hx_pos_bad5236c57cf1a4a_31_new)
            	HX_STACK_THIS(this)
