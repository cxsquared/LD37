...
HX_DEFINE_STACK_FRAME(_hx_pos_39b0deb1236c4593_339_new,"lime.system.JNIMethod","new",0xca67a7f2,"lime.system.JNIMethod.new","lime/system/JNI.hx",339,0x21970b7f)
HX_DEFINE_STACK_FRAME(_hx_pos_39b0deb1236c4593_343_callMember,"lime.system.JNIMethod","callMember",0x1acfd846,"lime.system.JNIMethod.callMember","lime/system/JNI.hx",343,0x21970b7f)
HX_DEFINE_STACK_FRAME(_hx_pos_39b0deb1236c4593_358_callStatic,"lime.system.JNIMethod","callStatic",0x1c15d29a,"lime.system.JNIMethod.callStatic","lime/system/JNI.hx",358,0x21970b7f)
HX_DEFINE_STACK_FRAME(_hx_pos_39b0deb1236c4593_368_getMemberMethod,"lime.system.JNIMethod","getMemberMethod",0x7872cd23,"lime.system.JNIMethod.getMemberMethod","lime/system/JNI.hx",368,0x21970b7f)
HX_DEFINE_STACK_FRAME(_hx_pos_39b0deb1236c4593_383_getStaticMethod,"lime.system.JNIMethod","getStaticMethod",0xd67b3e77,"lime.system.JNIMethod.getStaticMethod","lime/system/JNI.hx",383,0x21970b7f)
HX_DEFINE_STACK_FRAME(_hx_pos_39b0deb1236c4593_404_lime_jni_call_member,"lime.system.JNIMethod","lime_jni_call_member",0x66c88385,"lime.system.JNIMethod.lime_jni_call_member","lime/system/JNI.hx",404,0x21970b7f)
HX_DEFINE_STACK_FRAME(_hx_pos_39b0deb1236c4593_405_lime_jni_call_static,"lime.system.JNIMethod","lime_jni_call_static",0x680e7dd9,"lime.system.JNIMethod.lime_jni_call_static","lime/system/JNI.hx",405,0x21970b7f)
namespace lime{
namespace _hx_system{

void JNIMethod_obj::__construct( ::Dynamic method){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_339_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(method,"method")
HXLINE( 339)		this->method = method;
            	}
...
bool JNIMethod_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JNIMethod_obj::callMember(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_343_callMember)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(args,"args")
HXLINE( 346)		args->shift();
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,callMember,return )
 ...
 ::Dynamic JNIMethod_obj::callStatic(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_358_callStatic)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(args,"args")
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,callStatic,return )
 ...
 ::Dynamic JNIMethod_obj::getMemberMethod(bool useArray){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_368_getMemberMethod)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(useArray,"useArray")
HXLINE( 368)		if (useArray) {
HXLINE( 370)			return this->callMember_dyn();
            		}
            		else {
HXLINE( 374)			return ::Reflect_obj::makeVarArgs(this->callMember_dyn());
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,getMemberMethod,return )
 ...
 ::Dynamic JNIMethod_obj::getStaticMethod(bool useArray){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_383_getStaticMethod)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(useArray,"useArray")
HXLINE( 383)		if (useArray) {
HXLINE( 385)			return this->callStatic_dyn();
            		}
            		else {
HXLINE( 389)			return ::Reflect_obj::makeVarArgs(this->callStatic_dyn());
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,getStaticMethod,return )
 ...
 ::Dynamic JNIMethod_obj::lime_jni_call_member( ::Dynamic jniMethod, ::Dynamic jniObject, ::Dynamic args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_404_lime_jni_call_member)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(JNIMethod_obj,lime_jni_call_member,return )
 ...
 ::Dynamic JNIMethod_obj::lime_jni_call_static( ::Dynamic jniMethod, ::Dynamic args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_405_lime_jni_call_static)
            	HX_STACK_ARG(jniMethod,"jniMethod")
            	HX_STACK_ARG(args,"args")
