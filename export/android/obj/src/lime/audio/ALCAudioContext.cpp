...
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_9_new,"lime.audio.ALCAudioContext","new",0xf06c6612,"lime.audio.ALCAudioContext.new","lime/audio/ALCAudioContext.hx",9,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_44_closeDevice,"lime.audio.ALCAudioContext","closeDevice",0x21d89a20,"lime.audio.ALCAudioContext.closeDevice","lime/audio/ALCAudioContext.hx",44,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_51_createContext,"lime.audio.ALCAudioContext","createContext",0x0ee5d685,"lime.audio.ALCAudioContext.createContext","lime/audio/ALCAudioContext.hx",51,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_58_destroyContext,"lime.audio.ALCAudioContext","destroyContext",0xfeb347a3,"lime.audio.ALCAudioContext.destroyContext","lime/audio/ALCAudioContext.hx",58,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_65_getContextsDevice,"lime.audio.ALCAudioContext","getContextsDevice",0x919a57c2,"lime.audio.ALCAudioContext.getContextsDevice","lime/audio/ALCAudioContext.hx",65,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_72_getCurrentContext,"lime.audio.ALCAudioContext","getCurrentContext",0x8e88231e,"lime.audio.ALCAudioContext.getCurrentContext","lime/audio/ALCAudioContext.hx",72,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_79_getError,"lime.audio.ALCAudioContext","getError",0xe4326060,"lime.audio.ALCAudioContext.getError","lime/audio/ALCAudioContext.hx",79,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_86_getErrorString,"lime.audio.ALCAudioContext","getErrorString",0x000b8551,"lime.audio.ALCAudioContext.getErrorString","lime/audio/ALCAudioContext.hx",86,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_93_getIntegerv,"lime.audio.ALCAudioContext","getIntegerv",0x3d2ea360,"lime.audio.ALCAudioContext.getIntegerv","lime/audio/ALCAudioContext.hx",93,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_100_getString,"lime.audio.ALCAudioContext","getString",0x87a99939,"lime.audio.ALCAudioContext.getString","lime/audio/ALCAudioContext.hx",100,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_107_makeContextCurrent,"lime.audio.ALCAudioContext","makeContextCurrent",0x07220f26,"lime.audio.ALCAudioContext.makeContextCurrent","lime/audio/ALCAudioContext.hx",107,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_114_openDevice,"lime.audio.ALCAudioContext","openDevice",0xa37bac8e,"lime.audio.ALCAudioContext.openDevice","lime/audio/ALCAudioContext.hx",114,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_121_processContext,"lime.audio.ALCAudioContext","processContext",0x44a59ace,"lime.audio.ALCAudioContext.processContext","lime/audio/ALCAudioContext.hx",121,0x89fdd0e0)
HX_DEFINE_STACK_FRAME(_hx_pos_2578160cf6884b89_128_suspendContext,"lime.audio.ALCAudioContext","suspendContext",0x778c7961,"lime.audio.ALCAudioContext.suspendContext","lime/audio/ALCAudioContext.hx",128,0x89fdd0e0)
namespace lime{
namespace audio{

void ALCAudioContext_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_9_new)
            	HX_STACK_THIS(this)
...
bool ALCAudioContext_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x37cb6d50;
}

bool ALCAudioContext_obj::closeDevice( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_44_closeDevice)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,closeDevice,return )
 ...
 ::Dynamic ALCAudioContext_obj::createContext( ::Dynamic device,::Array< int > attrlist){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_51_createContext)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
void ALCAudioContext_obj::destroyContext( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_58_destroyContext)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,destroyContext,(void))
 ...
 ::Dynamic ALCAudioContext_obj::getContextsDevice( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_65_getContextsDevice)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,getContextsDevice,return )
 ...
 ::Dynamic ALCAudioContext_obj::getCurrentContext(){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_72_getCurrentContext)
            	HX_STACK_THIS(this)
...
int ALCAudioContext_obj::getError( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_79_getError)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
::String ALCAudioContext_obj::getErrorString( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_86_getErrorString)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
int count = __o_count.Default(1);
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_93_getIntegerv)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
...
::String ALCAudioContext_obj::getString( ::Dynamic device,int param){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_100_getString)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(device,"device")
            	HX_STACK_ARG(param,"param")
...
bool ALCAudioContext_obj::makeContextCurrent( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_107_makeContextCurrent)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,makeContextCurrent,return )
 ...
 ::Dynamic ALCAudioContext_obj::openDevice(::String deviceName){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_114_openDevice)
            	HX_STACK_THIS(this)
...
void ALCAudioContext_obj::processContext( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_121_processContext)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
            	}
...
void ALCAudioContext_obj::suspendContext( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_2578160cf6884b89_128_suspendContext)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(context,"context")
            	}
...
hx::ObjectPtr< ALCAudioContext_obj > ALCAudioContext_obj::__alloc(hx::Ctx *_hx_ctx) {
	ALCAudioContext_obj *__this = (ALCAudioContext_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(ALCAudioContext_obj), false, "lime.audio.ALCAudioContext"));
