...
HX_DEFINE_STACK_FRAME(_hx_pos_88dc58f908adf6d4_26_new,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void","new",0xcb63b279,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void.new","lime/app/Event.hx",26,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_88dc58f908adf6d4_38_add,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void","add",0xcb59d43a,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void.add","lime/app/Event.hx",38,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_88dc58f908adf6d4_211_cancel,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void","cancel",0x7343a101,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void.cancel","lime/app/Event.hx",211,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_88dc58f908adf6d4_247_has,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void","has",0xcb5f2173,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void.has","lime/app/Event.hx",247,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_88dc58f908adf6d4_262_remove,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void","remove",0xbf984fcb,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void.remove","lime/app/Event.hx",262,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_88dc58f908adf6d4_135_dispatch,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void","dispatch",0x836cb201,"lime.app.Event_Int_lime_ui_JoystickHatPosition_Void.dispatch","lime/app/Event.hx",135,0xbda45bec)
namespace lime{
namespace app{

void Event_Int_lime_ui_JoystickHatPosition_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_88dc58f908adf6d4_26_new)
            	HX_STACK_THIS(this)
...
void *Event_Int_lime_ui_JoystickHatPosition_Void_obj::_hx_vtable = 0;
...
bool Event_Int_lime_ui_JoystickHatPosition_Void_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1d93d58d;
}
...
int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_88dc58f908adf6d4_38_add)
            	HX_STACK_THIS(this)
...
void Event_Int_lime_ui_JoystickHatPosition_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_88dc58f908adf6d4_211_cancel)
            	HX_STACK_THIS(this)
...
bool Event_Int_lime_ui_JoystickHatPosition_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_88dc58f908adf6d4_247_has)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 250)		{
...
void Event_Int_lime_ui_JoystickHatPosition_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_88dc58f908adf6d4_262_remove)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void Event_Int_lime_ui_JoystickHatPosition_Void_obj::dispatch(int a,int a1){
            	HX_STACKFRAME(&_hx_pos_88dc58f908adf6d4_135_dispatch)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(a1,"a1")
...
hx::ObjectPtr< Event_Int_lime_ui_JoystickHatPosition_Void_obj > Event_Int_lime_ui_JoystickHatPosition_Void_obj::__new() {
	hx::ObjectPtr< Event_Int_lime_ui_JoystickHatPosition_Void_obj > __this = new Event_Int_lime_ui_JoystickHatPosition_Void_obj();
	__this->__construct();
	return __this;
}

hx::ObjectPtr< Event_Int_lime_ui_JoystickHatPosition_Void_obj > Event_Int_lime_ui_JoystickHatPosition_Void_obj::__alloc(hx::Ctx *_hx_ctx) {
	Event_Int_lime_ui_JoystickHatPosition_Void_obj *__this = (Event_Int_lime_ui_JoystickHatPosition_Void_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Event_Int_lime_ui_JoystickHatPosition_Void_obj), true, "lime.app.Event_Int_lime_ui_JoystickHatPosition_Void"));
	*(void **)__this = Event_Int_lime_ui_JoystickHatPosition_Void_obj::_hx_vtable;
	__this->__construct();
	return __this;
}
...
{
	hx::Object *dummy = new Event_Int_lime_ui_JoystickHatPosition_Void_obj;
	Event_Int_lime_ui_JoystickHatPosition_Void_obj::_hx_vtable = *(void **)dummy;
