...
HX_DEFINE_STACK_FRAME(_hx_pos_85bb0127476b2a1e_26_new,"lime.app.Event_Dynamic_Void","new",0x7b151c91,"lime.app.Event_Dynamic_Void.new","lime/app/Event.hx",26,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_85bb0127476b2a1e_38_add,"lime.app.Event_Dynamic_Void","add",0x7b0b3e52,"lime.app.Event_Dynamic_Void.add","lime/app/Event.hx",38,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_85bb0127476b2a1e_211_cancel,"lime.app.Event_Dynamic_Void","cancel",0x08ad95e9,"lime.app.Event_Dynamic_Void.cancel","lime/app/Event.hx",211,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_85bb0127476b2a1e_247_has,"lime.app.Event_Dynamic_Void","has",0x7b108b8b,"lime.app.Event_Dynamic_Void.has","lime/app/Event.hx",247,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_85bb0127476b2a1e_262_remove,"lime.app.Event_Dynamic_Void","remove",0x550244b3,"lime.app.Event_Dynamic_Void.remove","lime/app/Event.hx",262,0xbda45bec)
HX_DEFINE_STACK_FRAME(_hx_pos_85bb0127476b2a1e_135_dispatch,"lime.app.Event_Dynamic_Void","dispatch",0xbeebb0e9,"lime.app.Event_Dynamic_Void.dispatch","lime/app/Event.hx",135,0xbda45bec)
namespace lime{
namespace app{

void Event_Dynamic_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_85bb0127476b2a1e_26_new)
            	HX_STACK_THIS(this)
...
void *Event_Dynamic_Void_obj::_hx_vtable = 0;
...
bool Event_Dynamic_Void_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0f829615;
}
...
int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_85bb0127476b2a1e_38_add)
            	HX_STACK_THIS(this)
...
void Event_Dynamic_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_85bb0127476b2a1e_211_cancel)
            	HX_STACK_THIS(this)
...
bool Event_Dynamic_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_85bb0127476b2a1e_247_has)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 250)		{
...
void Event_Dynamic_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_85bb0127476b2a1e_262_remove)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
...
void Event_Dynamic_Void_obj::dispatch( ::Dynamic a){
            	HX_STACKFRAME(&_hx_pos_85bb0127476b2a1e_135_dispatch)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a,"a")
...
hx::ObjectPtr< Event_Dynamic_Void_obj > Event_Dynamic_Void_obj::__new() {
	hx::ObjectPtr< Event_Dynamic_Void_obj > __this = new Event_Dynamic_Void_obj();
	__this->__construct();
	return __this;
}

hx::ObjectPtr< Event_Dynamic_Void_obj > Event_Dynamic_Void_obj::__alloc(hx::Ctx *_hx_ctx) {
	Event_Dynamic_Void_obj *__this = (Event_Dynamic_Void_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Event_Dynamic_Void_obj), true, "lime.app.Event_Dynamic_Void"));
	*(void **)__this = Event_Dynamic_Void_obj::_hx_vtable;
	__this->__construct();
	return __this;
}
...
{
	hx::Object *dummy = new Event_Dynamic_Void_obj;
	Event_Dynamic_Void_obj::_hx_vtable = *(void **)dummy;
