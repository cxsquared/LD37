...
HX_DEFINE_STACK_FRAME(_hx_pos_548c78caa19a1a14_12_new,"openfl.display.Application","new",0x436ec718,"openfl.display.Application.new","openfl/display/Application.hx",12,0xe1d30bda)
HX_DEFINE_STACK_FRAME(_hx_pos_548c78caa19a1a14_25_create,"openfl.display.Application","create",0xb9517344,"openfl.display.Application.create","openfl/display/Application.hx",25,0xe1d30bda)
namespace openfl{
namespace display{

void Application_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_548c78caa19a1a14_12_new)
            	HX_STACK_THIS(this)
HXLINE(  14)		super::__construct();
HXLINE(  16)		if (hx::IsNull( ::openfl::Lib_obj::application )) {
...
void Application_obj::create( ::Dynamic config){
            	HX_GC_STACKFRAME(&_hx_pos_548c78caa19a1a14_25_create)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(config,"config")
HXLINE(  27)		this->config = config;
HXLINE(  29)		this->backend->create(config);
HXLINE(  31)		if (hx::IsNotNull( config )) {
HXLINE(  33)			if (::Reflect_obj::hasField(config,HX_("fps",e9,c7,4d,00))) {
HXLINE(  35)				this->backend->setFrameRate(( (Float)(config->__Field(HX_("fps",e9,c7,4d,00),hx::paccDynamic)) ));
            			}
HXLINE(  39)			if (::Reflect_obj::hasField(config,HX_("windows",83,de,74,e8))) {
...
HXLINE(  44)					this->createWindow( ::openfl::display::Window_obj::__alloc( HX_CTX ,windowConfig));
            				}
            			}
HXLINE(  54)			bool _hx_tmp;
HXDLIN(  54)			if (hx::IsNotNull( this->preloader )) {
HXLINE(  54)				_hx_tmp = this->preloader->complete;
            			}
            			else {
