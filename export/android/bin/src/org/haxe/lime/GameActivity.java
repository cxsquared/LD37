...
public class GameActivity extends Activity implements SensorEventListener {
	...
	public static int getResourceID (String inFilename) {
		...
		//
		//if (inFilename.equals("flixel/sounds/beep.ogg")) return com.example.myapp.R.raw.flixel_sounds_beep_ogg;
		//if (inFilename.equals("flixel/sounds/flixel.ogg")) return com.example.myapp.R.raw.flixel_sounds_flixel_ogg;
		//
		return -1;
